                                                ...
                                                hwaddr l, MemoryRegion *mr)
{
    ...
    for (;;) {
        if (!memory_access_is_direct(mr, true)) {
            ...
            panda_callbacks_replay_before_dma(buf, addr1, l, true);
            memcpy(ptr, buf, l);
            panda_callbacks_replay_after_dma(buf, addr1, l, true);
                                        ...
                                        MemoryRegion *mr)
{
    ...
    for (;;) {
        if (!memory_access_is_direct(mr, false)) {
            ...
            /* RAM case */
            ptr = qemu_ram_ptr_length(mr->ram_block, addr1, &l, false);
            panda_callbacks_replay_before_dma(buf, addr1, l, false);
            memcpy(buf, ptr, l);
            panda_callbacks_replay_after_dma(buf, addr1, l, false);
        }
