...
extern void afl_gen_compcov(uint64_t cur_loc, TCGv arg1, TCGv arg2, TCGMemOp ot, int is_imm);
#include "afl/types.h"
    ...
    if ((insn & 0x0f900000) == 0x03000000) {
        ...
        case 0x02:
            if (set_cc && rd == 15) {
                ...
                afl_gen_compcov(s->pc, (TCGv)tmp, (TCGv)tmp2, MO_32, insn & (1 << 25));
                   ...
                   TCGv_i32 t0, TCGv_i32 t1, int has_imm)
{
    ...
    case 13: /* sub */
        if (conds) {
            gen_sub_CC(t0, t0, t1);
            afl_gen_compcov(s->pc, (TCGv)t0, (TCGv)t1, MO_32, has_imm);
        } else
...
static void disas_thumb_insn(CPUARMState *env, DisasContext *s)
{
    ...
    TCGv_i32 tmp;
    TCGv_i32 tmp2;
    TCGv_i32 tmp3; // TODO might not support tmp3
    TCGv_i32 addr;
        ...
        if (op == 3) {
            ...
            if (insn & (1 << 9)) {
                if (s->condexec_mask)
                    ...
                    gen_sub_CC(tmp, tmp, tmp2);
                    afl_gen_compcov(s->pc, (TCGv)tmp, (TCGv)tmp2, MO_32, insn & (1 << 10));
                }
            } else {
                if (s->condexec_mask)
                    tcg_gen_add_i32(tmp, tmp, tmp2);
    ...
    case 2: case 3:
        ...
        if (op == 0) { /* mov */
            ...
            case 1: /* cmp */
                gen_sub_CC(tmp, tmp, tmp2);
                afl_gen_compcov(s->pc, (TCGv)tmp, (TCGv)tmp2, MO_32, 1);
                tcg_temp_free_i32(tmp);
                tcg_temp_free_i32(tmp2);
                break;
            case 2: /* add */
    ...
    case 4:
        ...
        if (insn & (1 << 10)) {
            ...
            case 1: /* cmp */
                ...
                tmp2 = load_reg(s, rm);
                gen_sub_CC(tmp, tmp, tmp2);
                afl_gen_compcov(s->pc, (TCGv)tmp, (TCGv)tmp2, MO_32, 0);
                tcg_temp_free_i32(tmp2);
                tcg_temp_free_i32(tmp);
                break;
            case 2: /* mov/cpy */
    ...
    case 13:
        ...
        if (cond == 0xf) {
            /* swi */
            target_ulong svc_imm = extract32(insn, 0, 8);
            if (svc_imm == 0x3f) {
                /* hyperCall */
                tmp = load_reg(s, 0);
                tmp2 = load_reg(s, 1);
