    ...
    hex_dump(stdout, (void *)(buf + desc_offset + vlan_offset),
             copy_size);
                ...
                do {
                    ...
                    // Immediately after we write the data, trigger our callback with the
                    // physical address of the guest buffer we just populated
                    panda_callbacks_packet_recv(first_cpu, ba, iov_copy);
