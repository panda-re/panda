...
static const char* log_entry_kind_str[] = {"RR_INPUT_1",
                                           "RR_INPUT_2",
                                           "RR_INPUT_4",
                                           "RR_INPUT_8",
                                           "RR_INTERRUPT_REQUEST",
...
typedef enum {
    ...
    RR_CALLSITE_IO_READ_ALL,
    RR_CALLSITE_IO_WRITE_ALL,
    ...
    RR_CALLSITE_ADDRESS_SPACE_READ_CONTINUE_8,
    RR_CALLSITE_ADDRESS_SPACE_READ_CONTINUE_4,
    RR_CALLSITE_ADDRESS_SPACE_READ_CONTINUE_2,
    RR_CALLSITE_ADDRESS_SPACE_READ_CONTINUE_1,
    RR_CALLSITE_ADDRESS_SPACE_LDL_INTERNAL,
    RR_CALLSITE_ADDRESS_SPACE_LDQ_INTERNAL,
    RR_CALLSITE_ADDRESS_SPACE_LDUW_INTERNAL,
    RR_CALLSITE_STL_INTERNAL,
    RR_CALLSITE_STW_INTERNAL,        
    RR_CALLSITE_LAST,
} RR_callsite_id;
