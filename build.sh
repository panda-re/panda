...
if [ $GCC_VERSION_MAJOR -ge $GCC_TOOLCHAIN_VERSION_REQ_MIN -a $GCXX_VERSION_MAJOR -ge $GCC_TOOLCHAIN_VERSION_REQ_MIN -a \
    $GCC_VERSION_MAJOR -le $GCC_TOOLCHAIN_VERSION_REQ_MAX -a $GCXX_VERSION_MAJOR -le $GCC_TOOLCHAIN_VERSION_REQ_MAX]; then
