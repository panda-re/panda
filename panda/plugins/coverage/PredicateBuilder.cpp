...
void PredicateBuilder::with_process_name(const std::string &pn)
{
...
void PredicateBuilder::with_pc_range(target_ulong low, target_ulong high)
{
...
void PredicateBuilder::in_kernel(bool ik)
{
