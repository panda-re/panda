...
void syscall_enter_switch_{{os}}_{{arch}} ( CPUState *cpu, target_ulong pc ) {  // osarch
#ifdef {{arch_conf.qemu_target}}                                          // GUARD
    CPUArchState *env = (CPUArchState*)cpu->env_ptr;
    ReturnPoint rp;
    rp.ordinal = {{arch_conf.rt_callno_reg}};                        // CALLNO
    rp.proc_id = panda_current_asid(cpu);
    rp.retaddr = calc_retaddr(cpu, pc);
    switch( {{arch_conf.rt_callno_reg}} ) {                          // CALLNO
