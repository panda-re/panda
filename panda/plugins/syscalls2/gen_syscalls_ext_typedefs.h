...
typedef void (*on_sys_ptrace_enter_t)(CPUState* cpu,target_ulong pc,int32_t request,int32_t pid,int32_t addr,int32_t data_arg);
...
typedef void (*on_sys_mount_enter_t)(CPUState* cpu,target_ulong pc,uint32_t dev_name,uint32_t dir_name,uint32_t type,uint32_t flags,uint32_t data_arg);
...
typedef void (*on_sys_capset_return_t)(CPUState* cpu,target_ulong pc,uint32_t header,uint32_t data_arg);
typedef void (*on_sys_mq_getsetattr_return_t)(CPUState* cpu,target_ulong pc,uint32_t mqdes,uint32_t mqstat,uint32_t omqstat);
typedef void (*on_sys_symlink_enter_t)(CPUState* cpu,target_ulong pc,uint32_t old,uint32_t anew);
...
typedef void (*on_sys_bdflush_return_t)(CPUState* cpu,target_ulong pc,int32_t func,int32_t data_arg);
...
typedef void (*on_sys_ptrace_return_t)(CPUState* cpu,target_ulong pc,int32_t request,int32_t pid,int32_t addr,int32_t data_arg);
...
typedef void (*on_sys_getcpu_enter_t)(CPUState* cpu,target_ulong pc,uint32_t cpu_fixed,uint32_t node,uint32_t cache);
...
typedef void (*on_sys_bdflush_enter_t)(CPUState* cpu,target_ulong pc,int32_t func,int32_t data_arg);
...
typedef void (*on_sys_mount_return_t)(CPUState* cpu,target_ulong pc,uint32_t dev_name,uint32_t dir_name,uint32_t type,uint32_t flags,uint32_t data_arg);
...
typedef void (*on_sys_symlink_return_t)(CPUState* cpu,target_ulong pc,uint32_t old,uint32_t anew);
...
typedef void (*on_sys_getcpu_return_t)(CPUState* cpu,target_ulong pc,uint32_t cpu_fixed,uint32_t node,uint32_t cache);
...
typedef void (*on_sys_capset_enter_t)(CPUState* cpu,target_ulong pc,uint32_t header,uint32_t data_arg);
...
typedef void (*on_sys_ptrace_enter_t)(CPUState* cpu,target_ulong pc,int32_t request,int32_t pid,uint32_t addr,uint32_t data_arg);
...
typedef void (*on_sys_perf_event_open_return_t)(CPUState* cpu,target_ulong pc,uint32_t attr_uptr,uint32_t pid,int32_t cpu_fixed,int32_t group_fd,uint32_t flags);
typedef void (*on_sys_rt_sigtimedwait_return_t)(CPUState* cpu,target_ulong pc,uint32_t uthese,uint32_t uinfo,uint32_t uts,uint32_t sigsetsize);
...
typedef void (*on_sys_perf_event_open_enter_t)(CPUState* cpu,target_ulong pc,uint32_t attr_uptr,uint32_t pid,int32_t cpu_fixed,int32_t group_fd,uint32_t flags);
typedef void (*on_sys_mincore_enter_t)(CPUState* cpu,target_ulong pc,uint32_t start,uint32_t len,uint32_t vec);
typedef void (*on_sys_link_return_t)(CPUState* cpu,target_ulong pc,uint32_t oldname,uint32_t newname);
typedef void (*on_sys_keyctl_enter_t)(CPUState* cpu,target_ulong pc,int32_t cmd,uint32_t arg2,uint32_t arg3,uint32_t arg4,uint32_t arg5);
typedef void (*on_sys_lseek_enter_t)(CPUState* cpu,target_ulong pc,uint32_t fd,uint32_t offset,uint32_t origin);
...
typedef void (*on_sys_ptrace_return_t)(CPUState* cpu,target_ulong pc,int32_t request,int32_t pid,uint32_t addr,uint32_t data_arg);
typedef void (*on_sys_rename_return_t)(CPUState* cpu,target_ulong pc,uint32_t oldname,uint32_t newname);
typedef void (*on_sys_sched_setaffinity_enter_t)(CPUState* cpu,target_ulong pc,uint32_t pid,uint32_t len,uint32_t user_mask_ptr);
