...
void syscall_enter_switch_freebsd_x64(CPUState *cpu, target_ulong tb_pc, target_ptr_t pc, int static_callno);
void syscall_enter_switch_linux_arm64(CPUState *cpu, target_ulong tb_pc, target_ptr_t pc, int static_callno);
...
void syscall_enter_switch_linux_x64(CPUState *cpu, target_ulong tb_pc, target_ptr_t pc, int static_callno);
void syscall_enter_switch_linux_x86(CPUState *cpu, target_ulong tb_pc, target_ptr_t pc, int static_callno);
void syscall_enter_switch_windows_2000_x86(CPUState *cpu, target_ulong tb_pc, target_ptr_t pc, int static_callno);
void syscall_enter_switch_windows_7_x86(CPUState *cpu, target_ulong tb_pc, target_ptr_t pc, int static_callno);
void syscall_enter_switch_windows_xpsp2_x86(CPUState *cpu, target_ulong tb_pc, target_ptr_t pc, int static_callno);
void syscall_enter_switch_windows_xpsp3_x86(CPUState *cpu, target_ulong tb_pc, target_ptr_t pc, int static_callno);
