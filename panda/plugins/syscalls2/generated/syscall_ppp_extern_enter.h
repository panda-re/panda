...
PPP_CB_EXTERN(on_sys___acl_aclcheck_fd_enter)
PPP_CB_EXTERN(on_sys___acl_aclcheck_file_enter)
PPP_CB_EXTERN(on_sys___acl_aclcheck_link_enter)
PPP_CB_EXTERN(on_sys___acl_delete_fd_enter)
PPP_CB_EXTERN(on_sys___acl_delete_file_enter)
PPP_CB_EXTERN(on_sys___acl_delete_link_enter)
PPP_CB_EXTERN(on_sys___acl_get_fd_enter)
PPP_CB_EXTERN(on_sys___acl_get_file_enter)
PPP_CB_EXTERN(on_sys___acl_get_link_enter)
PPP_CB_EXTERN(on_sys___acl_set_fd_enter)
PPP_CB_EXTERN(on_sys___acl_set_file_enter)
PPP_CB_EXTERN(on_sys___acl_set_link_enter)
PPP_CB_EXTERN(on_sys___mac_execve_enter)
PPP_CB_EXTERN(on_sys___mac_get_fd_enter)
PPP_CB_EXTERN(on_sys___mac_get_file_enter)
PPP_CB_EXTERN(on_sys___mac_get_link_enter)
PPP_CB_EXTERN(on_sys___mac_get_pid_enter)
PPP_CB_EXTERN(on_sys___mac_get_proc_enter)
PPP_CB_EXTERN(on_sys___mac_set_fd_enter)
PPP_CB_EXTERN(on_sys___mac_set_file_enter)
PPP_CB_EXTERN(on_sys___mac_set_link_enter)
PPP_CB_EXTERN(on_sys___mac_set_proc_enter)
PPP_CB_EXTERN(on_sys___realpathat_enter)
PPP_CB_EXTERN(on_sys___semctl_enter)
PPP_CB_EXTERN(on_sys___setugid_enter)
PPP_CB_EXTERN(on_sys___sysctl_enter)
PPP_CB_EXTERN(on_sys___sysctlbyname_enter)
PPP_CB_EXTERN(on_sys__umtx_op_enter)
PPP_CB_EXTERN(on_sys_abort2_enter)
PPP_CB_EXTERN(on_sys_accept_enter)
PPP_CB_EXTERN(on_sys_accept4_enter)
PPP_CB_EXTERN(on_sys_access_enter)
PPP_CB_EXTERN(on_sys_acct_enter)
PPP_CB_EXTERN(on_sys_add_key_enter)
PPP_CB_EXTERN(on_sys_adjtime_enter)
PPP_CB_EXTERN(on_sys_adjtimex_enter)
PPP_CB_EXTERN(on_sys_afs3_syscall_enter)
PPP_CB_EXTERN(on_sys_aio_cancel_enter)
PPP_CB_EXTERN(on_sys_aio_error_enter)
PPP_CB_EXTERN(on_sys_aio_fsync_enter)
PPP_CB_EXTERN(on_sys_aio_mlock_enter)
PPP_CB_EXTERN(on_sys_aio_read_enter)
PPP_CB_EXTERN(on_sys_aio_return_enter)
PPP_CB_EXTERN(on_sys_aio_suspend_enter)
PPP_CB_EXTERN(on_sys_aio_waitcomplete_enter)
PPP_CB_EXTERN(on_sys_aio_write_enter)
PPP_CB_EXTERN(on_sys_alarm_enter)
PPP_CB_EXTERN(on_sys_arch_prctl_enter)
PPP_CB_EXTERN(on_sys_audit_enter)
PPP_CB_EXTERN(on_sys_auditctl_enter)
PPP_CB_EXTERN(on_sys_auditon_enter)
PPP_CB_EXTERN(on_sys_bind_enter)
PPP_CB_EXTERN(on_sys_bindat_enter)
PPP_CB_EXTERN(on_sys_bpf_enter)
PPP_CB_EXTERN(on_sys_brk_enter)
PPP_CB_EXTERN(on_sys_cap_enter_enter)
PPP_CB_EXTERN(on_sys_cap_fcntls_get_enter)
PPP_CB_EXTERN(on_sys_cap_fcntls_limit_enter)
PPP_CB_EXTERN(on_sys_cap_getmode_enter)
PPP_CB_EXTERN(on_sys_cap_ioctls_get_enter)
PPP_CB_EXTERN(on_sys_cap_ioctls_limit_enter)
PPP_CB_EXTERN(on_sys_cap_rights_limit_enter)
PPP_CB_EXTERN(on_sys_capget_enter)
PPP_CB_EXTERN(on_sys_capset_enter)
PPP_CB_EXTERN(on_sys_chdir_enter)
PPP_CB_EXTERN(on_sys_chflags_enter)
PPP_CB_EXTERN(on_sys_chflagsat_enter)
PPP_CB_EXTERN(on_sys_chmod_enter)
PPP_CB_EXTERN(on_sys_chown_enter)
PPP_CB_EXTERN(on_sys_chroot_enter)
PPP_CB_EXTERN(on_sys_clock_adjtime_enter)
PPP_CB_EXTERN(on_sys_clock_getcpuclockid2_enter)
PPP_CB_EXTERN(on_sys_clock_getres_enter)
PPP_CB_EXTERN(on_sys_clock_gettime_enter)
PPP_CB_EXTERN(on_sys_clock_nanosleep_enter)
PPP_CB_EXTERN(on_sys_clock_settime_enter)
PPP_CB_EXTERN(on_sys_clone_enter)
PPP_CB_EXTERN(on_sys_close_enter)
PPP_CB_EXTERN(on_sys_close_range_enter)
PPP_CB_EXTERN(on_sys_closefrom_enter)
PPP_CB_EXTERN(on_sys_connect_enter)
PPP_CB_EXTERN(on_sys_connectat_enter)
PPP_CB_EXTERN(on_sys_copy_file_range_enter)
PPP_CB_EXTERN(on_sys_cpuset_enter)
PPP_CB_EXTERN(on_sys_cpuset_getaffinity_enter)
PPP_CB_EXTERN(on_sys_cpuset_getdomain_enter)
PPP_CB_EXTERN(on_sys_cpuset_getid_enter)
PPP_CB_EXTERN(on_sys_cpuset_setaffinity_enter)
PPP_CB_EXTERN(on_sys_cpuset_setdomain_enter)
PPP_CB_EXTERN(on_sys_cpuset_setid_enter)
PPP_CB_EXTERN(on_sys_creat_enter)
PPP_CB_EXTERN(on_sys_delete_module_enter)
PPP_CB_EXTERN(on_sys_dup_enter)
PPP_CB_EXTERN(on_sys_dup2_enter)
PPP_CB_EXTERN(on_sys_dup3_enter)
PPP_CB_EXTERN(on_sys_eaccess_enter)
PPP_CB_EXTERN(on_sys_epoll_create_enter)
PPP_CB_EXTERN(on_sys_epoll_create1_enter)
PPP_CB_EXTERN(on_sys_epoll_ctl_enter)
PPP_CB_EXTERN(on_sys_epoll_pwait_enter)
...
PPP_CB_EXTERN(on_sys_exit_enter)
PPP_CB_EXTERN(on_sys_exit_group_enter)
PPP_CB_EXTERN(on_sys_extattr_delete_fd_enter)
PPP_CB_EXTERN(on_sys_extattr_delete_file_enter)
PPP_CB_EXTERN(on_sys_extattr_delete_link_enter)
PPP_CB_EXTERN(on_sys_extattr_get_fd_enter)
PPP_CB_EXTERN(on_sys_extattr_get_file_enter)
PPP_CB_EXTERN(on_sys_extattr_get_link_enter)
PPP_CB_EXTERN(on_sys_extattr_list_fd_enter)
PPP_CB_EXTERN(on_sys_extattr_list_file_enter)
PPP_CB_EXTERN(on_sys_extattr_list_link_enter)
PPP_CB_EXTERN(on_sys_extattr_set_fd_enter)
PPP_CB_EXTERN(on_sys_extattr_set_file_enter)
PPP_CB_EXTERN(on_sys_extattr_set_link_enter)
PPP_CB_EXTERN(on_sys_extattrctl_enter)
PPP_CB_EXTERN(on_sys_faccessat_enter)
PPP_CB_EXTERN(on_sys_fadvise64_enter)
PPP_CB_EXTERN(on_sys_fallocate_enter)
PPP_CB_EXTERN(on_sys_fanotify_init_enter)
PPP_CB_EXTERN(on_sys_fanotify_mark_enter)
PPP_CB_EXTERN(on_sys_fchdir_enter)
PPP_CB_EXTERN(on_sys_fchflags_enter)
PPP_CB_EXTERN(on_sys_fchmod_enter)
PPP_CB_EXTERN(on_sys_fchmodat_enter)
PPP_CB_EXTERN(on_sys_fchown_enter)
PPP_CB_EXTERN(on_sys_fchownat_enter)
PPP_CB_EXTERN(on_sys_fcntl_enter)
PPP_CB_EXTERN(on_sys_fdatasync_enter)
PPP_CB_EXTERN(on_sys_fexecve_enter)
PPP_CB_EXTERN(on_sys_ffclock_getcounter_enter)
PPP_CB_EXTERN(on_sys_ffclock_getestimate_enter)
PPP_CB_EXTERN(on_sys_ffclock_setestimate_enter)
PPP_CB_EXTERN(on_sys_fgetxattr_enter)
PPP_CB_EXTERN(on_sys_fhlink_enter)
PPP_CB_EXTERN(on_sys_fhlinkat_enter)
PPP_CB_EXTERN(on_sys_fhopen_enter)
PPP_CB_EXTERN(on_sys_fhreadlink_enter)
PPP_CB_EXTERN(on_sys_fhstat_enter)
PPP_CB_EXTERN(on_sys_fhstatfs_enter)
PPP_CB_EXTERN(on_sys_finit_module_enter)
PPP_CB_EXTERN(on_sys_flistxattr_enter)
PPP_CB_EXTERN(on_sys_flock_enter)
PPP_CB_EXTERN(on_sys_fork_enter)
PPP_CB_EXTERN(on_sys_fpathconf_enter)
PPP_CB_EXTERN(on_sys_fremovexattr_enter)
PPP_CB_EXTERN(on_sys_fsetxattr_enter)
PPP_CB_EXTERN(on_sys_fstat_enter)
PPP_CB_EXTERN(on_sys_fstatat_enter)
PPP_CB_EXTERN(on_sys_fstatfs_enter)
PPP_CB_EXTERN(on_sys_fsync_enter)
PPP_CB_EXTERN(on_sys_ftruncate_enter)
PPP_CB_EXTERN(on_sys_funlinkat_enter)
PPP_CB_EXTERN(on_sys_futex_enter)
PPP_CB_EXTERN(on_sys_futimens_enter)
PPP_CB_EXTERN(on_sys_futimes_enter)
PPP_CB_EXTERN(on_sys_futimesat_enter)
PPP_CB_EXTERN(on_sys_get_mempolicy_enter)
PPP_CB_EXTERN(on_sys_get_robust_list_enter)
PPP_CB_EXTERN(on_sys_getaudit_enter)
PPP_CB_EXTERN(on_sys_getaudit_addr_enter)
PPP_CB_EXTERN(on_sys_getauid_enter)
PPP_CB_EXTERN(on_sys_getcontext_enter)
PPP_CB_EXTERN(on_sys_getcpu_enter)
PPP_CB_EXTERN(on_sys_getcwd_enter)
PPP_CB_EXTERN(on_sys_getdents_enter)
PPP_CB_EXTERN(on_sys_getdents64_enter)
PPP_CB_EXTERN(on_sys_getdirentries_enter)
PPP_CB_EXTERN(on_sys_getdomainname_enter)
PPP_CB_EXTERN(on_sys_getdtablesize_enter)
PPP_CB_EXTERN(on_sys_getegid_enter)
PPP_CB_EXTERN(on_sys_geteuid_enter)
PPP_CB_EXTERN(on_sys_getfh_enter)
PPP_CB_EXTERN(on_sys_getfhat_enter)
PPP_CB_EXTERN(on_sys_getfsstat_enter)
PPP_CB_EXTERN(on_sys_getgid_enter)
PPP_CB_EXTERN(on_sys_getgroups_enter)
PPP_CB_EXTERN(on_sys_gethostid_enter)
PPP_CB_EXTERN(on_sys_gethostname_enter)
PPP_CB_EXTERN(on_sys_getitimer_enter)
PPP_CB_EXTERN(on_sys_getkerninfo_enter)
PPP_CB_EXTERN(on_sys_getlogin_enter)
PPP_CB_EXTERN(on_sys_getloginclass_enter)
PPP_CB_EXTERN(on_sys_getpagesize_enter)
PPP_CB_EXTERN(on_sys_getpeername_enter)
PPP_CB_EXTERN(on_sys_getpgid_enter)
PPP_CB_EXTERN(on_sys_getpgrp_enter)
PPP_CB_EXTERN(on_sys_getpid_enter)
...
PPP_CB_EXTERN(on_sys_getuid_enter)
PPP_CB_EXTERN(on_sys_getxattr_enter)
PPP_CB_EXTERN(on_sys_gssd_syscall_enter)
PPP_CB_EXTERN(on_sys_init_module_enter)
PPP_CB_EXTERN(on_sys_inotify_add_watch_enter)
PPP_CB_EXTERN(on_sys_inotify_init_enter)
PPP_CB_EXTERN(on_sys_inotify_init1_enter)
...
PPP_CB_EXTERN(on_sys_ioprio_get_enter)
PPP_CB_EXTERN(on_sys_ioprio_set_enter)
PPP_CB_EXTERN(on_sys_issetugid_enter)
PPP_CB_EXTERN(on_sys_jail_enter)
PPP_CB_EXTERN(on_sys_jail_attach_enter)
PPP_CB_EXTERN(on_sys_jail_get_enter)
PPP_CB_EXTERN(on_sys_jail_remove_enter)
PPP_CB_EXTERN(on_sys_jail_set_enter)
PPP_CB_EXTERN(on_sys_kcmp_enter)
PPP_CB_EXTERN(on_sys_kenv_enter)
PPP_CB_EXTERN(on_sys_kevent_enter)
PPP_CB_EXTERN(on_sys_kexec_file_load_enter)
PPP_CB_EXTERN(on_sys_kexec_load_enter)
PPP_CB_EXTERN(on_sys_keyctl_enter)
PPP_CB_EXTERN(on_sys_kill_enter)
PPP_CB_EXTERN(on_sys_killpg_enter)
PPP_CB_EXTERN(on_sys_kldfind_enter)
PPP_CB_EXTERN(on_sys_kldfirstmod_enter)
PPP_CB_EXTERN(on_sys_kldload_enter)
PPP_CB_EXTERN(on_sys_kldnext_enter)
PPP_CB_EXTERN(on_sys_kldstat_enter)
PPP_CB_EXTERN(on_sys_kldsym_enter)
PPP_CB_EXTERN(on_sys_kldunload_enter)
PPP_CB_EXTERN(on_sys_kldunloadf_enter)
PPP_CB_EXTERN(on_sys_kmq_notify_enter)
PPP_CB_EXTERN(on_sys_kmq_open_enter)
PPP_CB_EXTERN(on_sys_kmq_setattr_enter)
PPP_CB_EXTERN(on_sys_kmq_timedreceive_enter)
PPP_CB_EXTERN(on_sys_kmq_timedsend_enter)
PPP_CB_EXTERN(on_sys_kmq_unlink_enter)
PPP_CB_EXTERN(on_sys_kqueue_enter)
PPP_CB_EXTERN(on_sys_ksem_close_enter)
PPP_CB_EXTERN(on_sys_ksem_destroy_enter)
PPP_CB_EXTERN(on_sys_ksem_getvalue_enter)
PPP_CB_EXTERN(on_sys_ksem_init_enter)
PPP_CB_EXTERN(on_sys_ksem_open_enter)
PPP_CB_EXTERN(on_sys_ksem_post_enter)
PPP_CB_EXTERN(on_sys_ksem_timedwait_enter)
PPP_CB_EXTERN(on_sys_ksem_trywait_enter)
PPP_CB_EXTERN(on_sys_ksem_unlink_enter)
PPP_CB_EXTERN(on_sys_ksem_wait_enter)
PPP_CB_EXTERN(on_sys_ktimer_create_enter)
PPP_CB_EXTERN(on_sys_ktimer_delete_enter)
PPP_CB_EXTERN(on_sys_ktimer_getoverrun_enter)
PPP_CB_EXTERN(on_sys_ktimer_gettime_enter)
PPP_CB_EXTERN(on_sys_ktimer_settime_enter)
PPP_CB_EXTERN(on_sys_ktrace_enter)
PPP_CB_EXTERN(on_sys_lchflags_enter)
PPP_CB_EXTERN(on_sys_lchmod_enter)
PPP_CB_EXTERN(on_sys_lchown_enter)
PPP_CB_EXTERN(on_sys_lgetfh_enter)
PPP_CB_EXTERN(on_sys_lgetxattr_enter)
PPP_CB_EXTERN(on_sys_link_enter)
PPP_CB_EXTERN(on_sys_linkat_enter)
PPP_CB_EXTERN(on_sys_lio_listio_enter)
PPP_CB_EXTERN(on_sys_listen_enter)
PPP_CB_EXTERN(on_sys_listxattr_enter)
PPP_CB_EXTERN(on_sys_llistxattr_enter)
PPP_CB_EXTERN(on_sys_lookup_dcookie_enter)
PPP_CB_EXTERN(on_sys_lpathconf_enter)
PPP_CB_EXTERN(on_sys_lremovexattr_enter)
PPP_CB_EXTERN(on_sys_lseek_enter)
PPP_CB_EXTERN(on_sys_lsetxattr_enter)
PPP_CB_EXTERN(on_sys_lstat_enter)
PPP_CB_EXTERN(on_sys_lutimes_enter)
PPP_CB_EXTERN(on_sys_mac_syscall_enter)
PPP_CB_EXTERN(on_sys_madvise_enter)
PPP_CB_EXTERN(on_sys_mbind_enter)
PPP_CB_EXTERN(on_sys_membarrier_enter)
PPP_CB_EXTERN(on_sys_memfd_create_enter)
PPP_CB_EXTERN(on_sys_migrate_pages_enter)
PPP_CB_EXTERN(on_sys_mincore_enter)
PPP_CB_EXTERN(on_sys_minherit_enter)
PPP_CB_EXTERN(on_sys_mkdir_enter)
PPP_CB_EXTERN(on_sys_mkdirat_enter)
PPP_CB_EXTERN(on_sys_mkfifo_enter)
PPP_CB_EXTERN(on_sys_mkfifoat_enter)
PPP_CB_EXTERN(on_sys_mknod_enter)
PPP_CB_EXTERN(on_sys_mknodat_enter)
PPP_CB_EXTERN(on_sys_mlock_enter)
PPP_CB_EXTERN(on_sys_mlock2_enter)
PPP_CB_EXTERN(on_sys_mlockall_enter)
PPP_CB_EXTERN(on_sys_mmap_enter)
PPP_CB_EXTERN(on_sys_modfind_enter)
PPP_CB_EXTERN(on_sys_modfnext_enter)
PPP_CB_EXTERN(on_sys_modify_ldt_enter)
PPP_CB_EXTERN(on_sys_modnext_enter)
PPP_CB_EXTERN(on_sys_modstat_enter)
PPP_CB_EXTERN(on_sys_mount_enter)
PPP_CB_EXTERN(on_sys_move_pages_enter)
PPP_CB_EXTERN(on_sys_mprotect_enter)
PPP_CB_EXTERN(on_sys_mq_getsetattr_enter)
...
PPP_CB_EXTERN(on_sys_newstat_enter)
PPP_CB_EXTERN(on_sys_newuname_enter)
PPP_CB_EXTERN(on_sys_nfssvc_enter)
PPP_CB_EXTERN(on_sys_nfstat_enter)
PPP_CB_EXTERN(on_sys_nlm_syscall_enter)
PPP_CB_EXTERN(on_sys_nlstat_enter)
PPP_CB_EXTERN(on_sys_nmount_enter)
PPP_CB_EXTERN(on_sys_nnpfs_syscall_enter)
PPP_CB_EXTERN(on_sys_nosys_enter)
PPP_CB_EXTERN(on_sys_nstat_enter)
PPP_CB_EXTERN(on_sys_ntp_adjtime_enter)
PPP_CB_EXTERN(on_sys_ntp_gettime_enter)
PPP_CB_EXTERN(on_sys_open_enter)
PPP_CB_EXTERN(on_sys_open_by_handle_at_enter)
PPP_CB_EXTERN(on_sys_openat_enter)
PPP_CB_EXTERN(on_sys_pathconf_enter)
PPP_CB_EXTERN(on_sys_pause_enter)
PPP_CB_EXTERN(on_sys_pdfork_enter)
PPP_CB_EXTERN(on_sys_pdgetpid_enter)
PPP_CB_EXTERN(on_sys_pdkill_enter)
PPP_CB_EXTERN(on_sys_perf_event_open_enter)
PPP_CB_EXTERN(on_sys_personality_enter)
PPP_CB_EXTERN(on_sys_pipe_enter)
PPP_CB_EXTERN(on_sys_pipe2_enter)
...
PPP_CB_EXTERN(on_sys_pkey_mprotect_enter)
PPP_CB_EXTERN(on_sys_poll_enter)
PPP_CB_EXTERN(on_sys_posix_fadvise_enter)
PPP_CB_EXTERN(on_sys_posix_fallocate_enter)
PPP_CB_EXTERN(on_sys_posix_openpt_enter)
PPP_CB_EXTERN(on_sys_ppoll_enter)
PPP_CB_EXTERN(on_sys_prctl_enter)
PPP_CB_EXTERN(on_sys_pread_enter)
PPP_CB_EXTERN(on_sys_pread64_enter)
PPP_CB_EXTERN(on_sys_preadv_enter)
PPP_CB_EXTERN(on_sys_preadv2_enter)
PPP_CB_EXTERN(on_sys_prlimit64_enter)
PPP_CB_EXTERN(on_sys_procctl_enter)
PPP_CB_EXTERN(on_sys_process_vm_readv_enter)
PPP_CB_EXTERN(on_sys_process_vm_writev_enter)
PPP_CB_EXTERN(on_sys_profil_enter)
PPP_CB_EXTERN(on_sys_pselect_enter)
PPP_CB_EXTERN(on_sys_pselect6_enter)
PPP_CB_EXTERN(on_sys_ptrace_enter)
PPP_CB_EXTERN(on_sys_pwrite_enter)
PPP_CB_EXTERN(on_sys_pwrite64_enter)
PPP_CB_EXTERN(on_sys_pwritev_enter)
PPP_CB_EXTERN(on_sys_pwritev2_enter)
PPP_CB_EXTERN(on_sys_quota_enter)
PPP_CB_EXTERN(on_sys_quotactl_enter)
PPP_CB_EXTERN(on_sys_rctl_add_rule_enter)
PPP_CB_EXTERN(on_sys_rctl_get_limits_enter)
PPP_CB_EXTERN(on_sys_rctl_get_racct_enter)
PPP_CB_EXTERN(on_sys_rctl_get_rules_enter)
PPP_CB_EXTERN(on_sys_rctl_remove_rule_enter)
PPP_CB_EXTERN(on_sys_read_enter)
PPP_CB_EXTERN(on_sys_readahead_enter)
PPP_CB_EXTERN(on_sys_readlink_enter)
PPP_CB_EXTERN(on_sys_readlinkat_enter)
...
PPP_CB_EXTERN(on_sys_request_key_enter)
PPP_CB_EXTERN(on_sys_restart_syscall_enter)
PPP_CB_EXTERN(on_sys_revoke_enter)
PPP_CB_EXTERN(on_sys_rfork_enter)
PPP_CB_EXTERN(on_sys_rmdir_enter)
PPP_CB_EXTERN(on_sys_rpctls_syscall_enter)
PPP_CB_EXTERN(on_sys_rt_sigaction_enter)
PPP_CB_EXTERN(on_sys_rt_sigpending_enter)
PPP_CB_EXTERN(on_sys_rt_sigprocmask_enter)
PPP_CB_EXTERN(on_sys_rt_sigqueueinfo_enter)
...
PPP_CB_EXTERN(on_sys_rt_sigtimedwait_enter)
PPP_CB_EXTERN(on_sys_rt_tgsigqueueinfo_enter)
PPP_CB_EXTERN(on_sys_rtprio_enter)
PPP_CB_EXTERN(on_sys_rtprio_thread_enter)
PPP_CB_EXTERN(on_sys_sbrk_enter)
PPP_CB_EXTERN(on_sys_sched_get_priority_max_enter)
PPP_CB_EXTERN(on_sys_sched_get_priority_min_enter)
PPP_CB_EXTERN(on_sys_sched_getaffinity_enter)
PPP_CB_EXTERN(on_sys_sched_getattr_enter)
...
PPP_CB_EXTERN(on_sys_sched_setscheduler_enter)
PPP_CB_EXTERN(on_sys_sched_yield_enter)
PPP_CB_EXTERN(on_sys_sctp_generic_recvmsg_enter)
PPP_CB_EXTERN(on_sys_sctp_generic_sendmsg_enter)
PPP_CB_EXTERN(on_sys_sctp_generic_sendmsg_iov_enter)
PPP_CB_EXTERN(on_sys_sctp_peeloff_enter)
PPP_CB_EXTERN(on_sys_seccomp_enter)
PPP_CB_EXTERN(on_sys_select_enter)
PPP_CB_EXTERN(on_sys_semctl_enter)
PPP_CB_EXTERN(on_sys_semget_enter)
PPP_CB_EXTERN(on_sys_semop_enter)
PPP_CB_EXTERN(on_sys_semsys_enter)
PPP_CB_EXTERN(on_sys_semtimedop_enter)
PPP_CB_EXTERN(on_sys_send_enter)
PPP_CB_EXTERN(on_sys_sendfile_enter)
PPP_CB_EXTERN(on_sys_sendfile64_enter)
...
PPP_CB_EXTERN(on_sys_set_robust_list_enter)
PPP_CB_EXTERN(on_sys_set_tid_address_enter)
PPP_CB_EXTERN(on_sys_setaudit_enter)
PPP_CB_EXTERN(on_sys_setaudit_addr_enter)
PPP_CB_EXTERN(on_sys_setauid_enter)
PPP_CB_EXTERN(on_sys_setcontext_enter)
PPP_CB_EXTERN(on_sys_setdomainname_enter)
PPP_CB_EXTERN(on_sys_setegid_enter)
PPP_CB_EXTERN(on_sys_seteuid_enter)
PPP_CB_EXTERN(on_sys_setfib_enter)
PPP_CB_EXTERN(on_sys_setfsgid_enter)
PPP_CB_EXTERN(on_sys_setfsuid_enter)
PPP_CB_EXTERN(on_sys_setgid_enter)
PPP_CB_EXTERN(on_sys_setgroups_enter)
PPP_CB_EXTERN(on_sys_sethostid_enter)
PPP_CB_EXTERN(on_sys_sethostname_enter)
PPP_CB_EXTERN(on_sys_setitimer_enter)
PPP_CB_EXTERN(on_sys_setlogin_enter)
PPP_CB_EXTERN(on_sys_setloginclass_enter)
PPP_CB_EXTERN(on_sys_setns_enter)
PPP_CB_EXTERN(on_sys_setpgid_enter)
PPP_CB_EXTERN(on_sys_setpriority_enter)
PPP_CB_EXTERN(on_sys_setregid_enter)
...
PPP_CB_EXTERN(on_sys_setuid_enter)
PPP_CB_EXTERN(on_sys_setxattr_enter)
PPP_CB_EXTERN(on_sys_shm_open_enter)
PPP_CB_EXTERN(on_sys_shm_open2_enter)
PPP_CB_EXTERN(on_sys_shm_rename_enter)
PPP_CB_EXTERN(on_sys_shm_unlink_enter)
PPP_CB_EXTERN(on_sys_shmat_enter)
PPP_CB_EXTERN(on_sys_shmctl_enter)
PPP_CB_EXTERN(on_sys_shmdt_enter)
PPP_CB_EXTERN(on_sys_shmget_enter)
...
PPP_CB_EXTERN(on_sys_sigaction_enter)
PPP_CB_EXTERN(on_sys_sigaltstack_enter)
PPP_CB_EXTERN(on_sys_sigblock_enter)
PPP_CB_EXTERN(on_sys_sigfastblock_enter)
PPP_CB_EXTERN(on_sys_signalfd_enter)
PPP_CB_EXTERN(on_sys_signalfd4_enter)
PPP_CB_EXTERN(on_sys_sigpending_enter)
PPP_CB_EXTERN(on_sys_sigprocmask_enter)
PPP_CB_EXTERN(on_sys_sigqueue_enter)
PPP_CB_EXTERN(on_sys_sigreturn_enter)
PPP_CB_EXTERN(on_sys_sigsetmask_enter)
PPP_CB_EXTERN(on_sys_sigstack_enter)
PPP_CB_EXTERN(on_sys_sigsuspend_enter)
PPP_CB_EXTERN(on_sys_sigtimedwait_enter)
PPP_CB_EXTERN(on_sys_sigvec_enter)
PPP_CB_EXTERN(on_sys_sigwait_enter)
PPP_CB_EXTERN(on_sys_sigwaitinfo_enter)
PPP_CB_EXTERN(on_sys_socket_enter)
PPP_CB_EXTERN(on_sys_socketpair_enter)
PPP_CB_EXTERN(on_sys_splice_enter)
PPP_CB_EXTERN(on_sys_sstk_enter)
PPP_CB_EXTERN(on_sys_stat_enter)
PPP_CB_EXTERN(on_sys_statfs_enter)
PPP_CB_EXTERN(on_sys_statx_enter)
PPP_CB_EXTERN(on_sys_swapcontext_enter)
PPP_CB_EXTERN(on_sys_swapoff_enter)
PPP_CB_EXTERN(on_sys_swapon_enter)
PPP_CB_EXTERN(on_sys_symlink_enter)
PPP_CB_EXTERN(on_sys_symlinkat_enter)
...
PPP_CB_EXTERN(on_sys_sync_file_range_enter)
PPP_CB_EXTERN(on_sys_syncfs_enter)
PPP_CB_EXTERN(on_sys_sysarch_enter)
PPP_CB_EXTERN(on_sys_sysctl_enter)
PPP_CB_EXTERN(on_sys_sysfs_enter)
PPP_CB_EXTERN(on_sys_sysinfo_enter)
PPP_CB_EXTERN(on_sys_syslog_enter)
PPP_CB_EXTERN(on_sys_tee_enter)
PPP_CB_EXTERN(on_sys_tgkill_enter)
PPP_CB_EXTERN(on_sys_thr_create_enter)
PPP_CB_EXTERN(on_sys_thr_exit_enter)
PPP_CB_EXTERN(on_sys_thr_kill_enter)
PPP_CB_EXTERN(on_sys_thr_kill2_enter)
PPP_CB_EXTERN(on_sys_thr_new_enter)
PPP_CB_EXTERN(on_sys_thr_self_enter)
PPP_CB_EXTERN(on_sys_thr_set_name_enter)
PPP_CB_EXTERN(on_sys_thr_suspend_enter)
PPP_CB_EXTERN(on_sys_thr_wake_enter)
PPP_CB_EXTERN(on_sys_time_enter)
PPP_CB_EXTERN(on_sys_timer_create_enter)
PPP_CB_EXTERN(on_sys_timer_delete_enter)
PPP_CB_EXTERN(on_sys_timer_getoverrun_enter)
...
PPP_CB_EXTERN(on_sys_umount_enter)
PPP_CB_EXTERN(on_sys_uname_enter)
PPP_CB_EXTERN(on_sys_undelete_enter)
PPP_CB_EXTERN(on_sys_unlink_enter)
PPP_CB_EXTERN(on_sys_unlinkat_enter)
PPP_CB_EXTERN(on_sys_unmount_enter)
PPP_CB_EXTERN(on_sys_unshare_enter)
PPP_CB_EXTERN(on_sys_userfaultfd_enter)
PPP_CB_EXTERN(on_sys_ustat_enter)
PPP_CB_EXTERN(on_sys_utime_enter)
PPP_CB_EXTERN(on_sys_utimensat_enter)
PPP_CB_EXTERN(on_sys_utimes_enter)
PPP_CB_EXTERN(on_sys_utrace_enter)
PPP_CB_EXTERN(on_sys_uuidgen_enter)
PPP_CB_EXTERN(on_sys_vadvise_enter)
PPP_CB_EXTERN(on_sys_vfork_enter)
PPP_CB_EXTERN(on_sys_vhangup_enter)
PPP_CB_EXTERN(on_sys_vmsplice_enter)
PPP_CB_EXTERN(on_sys_wait_enter)
PPP_CB_EXTERN(on_sys_wait4_enter)
PPP_CB_EXTERN(on_sys_wait6_enter)
PPP_CB_EXTERN(on_sys_waitid_enter)
PPP_CB_EXTERN(on_sys_write_enter)
PPP_CB_EXTERN(on_sys_writev_enter)
PPP_CB_EXTERN(on_sys_yield_enter)
#endif
