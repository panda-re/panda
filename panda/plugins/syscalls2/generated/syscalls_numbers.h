...
namespace syscalls2 {
	...
	namespace linux {
		namespace mips {
			...
			const int sys_adjtimex_time32 = 124;
			...
			const int sys_getsid = 151;
			const int sys_fdatasync = 152;
			const int sys_sysctl = 153;
			const int sys_mlock = 154;
			const int sys_munlock = 155;
			const int sys_mlockall = 156;
			const int sys_munlockall = 157;
			const int sys_sched_setparam = 158;
			const int sys_sched_getparam = 159;
			const int sys_sched_setscheduler = 160;
			const int sys_sched_getscheduler = 161;
			const int sys_sched_yield = 162;
			const int sys_sched_get_priority_max = 163;
			const int sys_sched_get_priority_min = 164;
			const int sys_sched_rr_get_interval_time32 = 165;
			const int sys_nanosleep_time32 = 166;
			const int sys_mremap = 167;
			const int sys_accept = 168;
			const int sys_bind = 169;
			const int sys_connect = 170;
			const int sys_getpeername = 171;
			const int sys_getsockname = 172;
			const int sys_getsockopt = 173;
			const int sys_listen = 174;
			const int sys_recv = 175;
			const int sys_recvfrom = 176;
			const int sys_recvmsg = 177;
			const int sys_send = 178;
			const int sys_sendmsg = 179;
			const int sys_sendto = 180;
			const int sys_setsockopt = 181;
			const int sys_shutdown = 182;
			const int sys_socket = 183;
			const int sys_socketpair = 184;
			const int sys_setresuid = 185;
			const int sys_getresuid = 186;
			const int sys_poll = 188;
			const int sys_setresgid = 190;
			const int sys_getresgid = 191;
			const int sys_prctl = 192;
			const int sys_rt_sigreturn = 193;
			const int sys_rt_sigaction = 194;
			const int sys_rt_sigprocmask = 195;
			const int sys_rt_sigpending = 196;
			const int sys_rt_sigtimedwait_time32 = 197;
			const int sys_rt_sigqueueinfo = 198;
			const int sys_rt_sigsuspend = 199;
			const int sys_pread64 = 200;
			const int sys_pwrite64 = 201;
			const int sys_chown = 202;
			const int sys_getcwd = 203;
			const int sys_capget = 204;
			const int sys_capset = 205;
			const int sys_sigaltstack = 206;
			const int sys_sendfile = 207;
			const int sys_truncate64 = 211;
			const int sys_ftruncate64 = 212;
			const int sys_stat64 = 213;
			const int sys_lstat64 = 214;
			const int sys_fstat64 = 215;
			const int sys_pivot_root = 216;
			const int sys_mincore = 217;
			const int sys_madvise = 218;
			const int sys_getdents64 = 219;
			const int sys_fcntl64 = 220;
			const int sys_gettid = 222;
			const int sys_readahead = 223;
			const int sys_setxattr = 224;
			const int sys_lsetxattr = 225;
			const int sys_fsetxattr = 226;
			const int sys_getxattr = 227;
			const int sys_lgetxattr = 228;
			const int sys_fgetxattr = 229;
			const int sys_listxattr = 230;
			const int sys_llistxattr = 231;
			const int sys_flistxattr = 232;
			const int sys_removexattr = 233;
			const int sys_lremovexattr = 234;
			const int sys_fremovexattr = 235;
			const int sys_tkill = 236;
			const int sys_sendfile64 = 237;
			const int sys_futex_time32 = 238;
			const int sys_sched_setaffinity = 239;
			const int sys_sched_getaffinity = 240;
			const int sys_io_setup = 241;
			const int sys_io_destroy = 242;
			const int sys_io_getevents_time32 = 243;
			const int sys_io_submit = 244;
			const int sys_io_cancel = 245;
			const int sys_exit_group = 246;
			const int sys_lookup_dcookie = 247;
			const int sys_epoll_create = 248;
			const int sys_epoll_ctl = 249;
			const int sys_epoll_wait = 250;
			const int sys_remap_file_pages = 251;
			const int sys_set_tid_address = 252;
			const int sys_restart_syscall = 253;
			const int sys_fadvise64_64 = 254;
			const int sys_statfs64 = 255;
			const int sys_fstatfs64 = 256;
			const int sys_timer_create = 257;
			const int sys_timer_settime32 = 258;
			const int sys_timer_gettime32 = 259;
			const int sys_timer_getoverrun = 260;
			const int sys_timer_delete = 261;
			const int sys_clock_settime32 = 262;
			const int sys_clock_gettime32 = 263;
			const int sys_clock_getres_time32 = 264;
			const int sys_clock_nanosleep_time32 = 265;
			const int sys_tgkill = 266;
			const int sys_utimes_time32 = 267;
			const int sys_mbind = 268;
			const int sys_get_mempolicy = 269;
			const int sys_set_mempolicy = 270;
			const int sys_mq_open = 271;
			const int sys_mq_unlink = 272;
			const int sys_mq_timedsend_time32 = 273;
			const int sys_mq_timedreceive_time32 = 274;
			const int sys_mq_notify = 275;
			const int sys_mq_getsetattr = 276;
			const int sys_waitid = 278;
			const int sys_add_key = 280;
			const int sys_request_key = 281;
			const int sys_keyctl = 282;
			const int sys_inotify_init = 284;
			const int sys_inotify_add_watch = 285;
			const int sys_inotify_rm_watch = 286;
			const int sys_migrate_pages = 287;
			const int sys_openat = 288;
			const int sys_mkdirat = 289;
			const int sys_mknodat = 290;
			const int sys_fchownat = 291;
			const int sys_futimesat_time32 = 292;
			const int sys_fstatat64 = 293;
			const int sys_unlinkat = 294;
			const int sys_renameat = 295;
			const int sys_linkat = 296;
			const int sys_symlinkat = 297;
			const int sys_readlinkat = 298;
			const int sys_fchmodat = 299;
			const int sys_faccessat = 300;
			const int sys_pselect6_time32 = 301;
			const int sys_ppoll_time32 = 302;
			const int sys_unshare = 303;
			const int sys_splice = 304;
			const int sys_sync_file_range = 305;
			const int sys_tee = 306;
			const int sys_vmsplice = 307;
			const int sys_move_pages = 308;
			const int sys_set_robust_list = 309;
			const int sys_get_robust_list = 310;
			const int sys_kexec_load = 311;
			const int sys_getcpu = 312;
			const int sys_epoll_pwait = 313;
			const int sys_ioprio_set = 314;
			const int sys_ioprio_get = 315;
			const int sys_utimensat_time32 = 316;
			const int sys_signalfd = 317;
			const int sys_ni_syscall = 318;
			const int sys_eventfd = 319;
			const int sys_fallocate = 320;
			const int sys_timerfd_create = 321;
			const int sys_timerfd_gettime32 = 322;
			const int sys_timerfd_settime32 = 323;
			const int sys_signalfd4 = 324;
			const int sys_eventfd2 = 325;
			const int sys_epoll_create1 = 326;
			const int sys_dup3 = 327;
			const int sys_pipe2 = 328;
			const int sys_inotify_init1 = 329;
			const int sys_preadv = 330;
			const int sys_pwritev = 331;
			const int sys_rt_tgsigqueueinfo = 332;
			const int sys_perf_event_open = 333;
			const int sys_accept4 = 334;
			const int sys_recvmmsg_time32 = 335;
			const int sys_fanotify_init = 336;
			const int sys_fanotify_mark = 337;
			const int sys_prlimit64 = 338;
			const int sys_name_to_handle_at = 339;
			const int sys_open_by_handle_at = 340;
			const int sys_clock_adjtime32 = 341;
			const int sys_syncfs = 342;
			const int sys_sendmmsg = 343;
			const int sys_setns = 344;
			const int sys_process_vm_readv = 345;
			const int sys_process_vm_writev = 346;
			const int sys_kcmp = 347;
			const int sys_finit_module = 348;
			const int sys_sched_setattr = 349;
			const int sys_sched_getattr = 350;
			const int sys_renameat2 = 351;
			const int sys_seccomp = 352;
			const int sys_getrandom = 353;
			const int sys_memfd_create = 354;
			const int sys_bpf = 355;
			const int sys_execveat = 356;
			const int sys_userfaultfd = 357;
			const int sys_membarrier = 358;
			const int sys_mlock2 = 359;
			const int sys_copy_file_range = 360;
			const int sys_preadv2 = 361;
			const int sys_pwritev2 = 362;
			const int sys_pkey_mprotect = 363;
			const int sys_pkey_alloc = 364;
			const int sys_pkey_free = 365;
			const int sys_statx = 366;
			const int sys_rseq = 367;
			const int sys_io_pgetevents_time32 = 368;
			...
			const int sys_clock_gettime = 403;
			const int sys_clock_settime = 404;
			const int sys_clock_adjtime = 405;
			const int sys_clock_getres = 406;
			const int sys_clock_nanosleep = 407;
			const int sys_timer_gettime = 408;
			const int sys_timer_settime = 409;
			const int sys_timerfd_gettime = 410;
			const int sys_timerfd_settime = 411;
			const int sys_utimensat = 412;
			const int sys_pselect6 = 413;
			const int sys_ppoll = 414;
			const int sys_io_pgetevents = 416;
			const int sys_recvmmsg = 417;
			const int sys_mq_timedsend = 418;
			const int sys_mq_timedreceive = 419;
			const int sys_semtimedop = 420;
			const int sys_rt_sigtimedwait = 421;
			const int sys_futex = 422;
			const int sys_sched_rr_get_interval = 423;
