...
namespace syscalls2 {
	...
	namespace freebsd {
		namespace x64 {
			...
			const int sys_open = 5;
			const int sys_close = 6;
			const int sys_wait4 = 7;
			const int sys_creat = 8;
			const int sys_link = 9;
			const int sys_unlink = 10;
			const int sys_chdir = 12;
			const int sys_fchdir = 13;
			const int sys_mknod = 14;
			const int sys_chmod = 15;
			const int sys_chown = 16;
			const int sys_getfsstat = 18;
			const int sys_getpid = 20;
			const int sys_mount = 21;
			const int sys_unmount = 22;
			const int sys_setuid = 23;
			const int sys_getuid = 24;
			const int sys_geteuid = 25;
			const int sys_ptrace = 26;
			const int sys_recvmsg = 27;
			const int sys_sendmsg = 28;
			const int sys_recvfrom = 29;
			const int sys_accept = 30;
			const int sys_getpeername = 31;
			const int sys_getsockname = 32;
			const int sys_access = 33;
			const int sys_chflags = 34;
			const int sys_fchflags = 35;
			const int sys_sync = 36;
			const int sys_kill = 37;
			const int sys_stat = 38;
			const int sys_getppid = 39;
			const int sys_lstat = 40;
			const int sys_dup = 41;
			const int sys_pipe = 42;
			const int sys_getegid = 43;
			const int sys_profil = 44;
			const int sys_ktrace = 45;
			const int sys_sigaction = 46;
			const int sys_getgid = 47;
			const int sys_getlogin = 49;
			const int sys_setlogin = 50;
			const int sys_acct = 51;
			const int sys_sigaltstack = 53;
			const int sys_ioctl = 54;
			const int sys_reboot = 55;
			const int sys_revoke = 56;
			const int sys_symlink = 57;
			const int sys_readlink = 58;
			const int sys_execve = 59;
			const int sys_umask = 60;
			const int sys_chroot = 61;
			const int sys_fstat = 62;
			const int sys_getkerninfo = 63;
			const int sys_getpagesize = 64;
			const int sys_msync = 65;
			const int sys_vfork = 66;
			const int sys_sbrk = 69;
			const int sys_sstk = 70;
			const int sys_vadvise = 72;
			const int sys_munmap = 73;
			const int sys_mprotect = 74;
			const int sys_madvise = 75;
			const int sys_mincore = 78;
			const int sys_getgroups = 79;
			const int sys_setgroups = 80;
			const int sys_getpgrp = 81;
			const int sys_setpgid = 82;
			const int sys_setitimer = 83;
			const int sys_wait = 84;
			const int sys_swapon = 85;
			const int sys_getitimer = 86;
			const int sys_gethostname = 87;
			const int sys_sethostname = 88;
			const int sys_getdtablesize = 89;
			const int sys_dup2 = 90;
			const int sys_fcntl = 92;
			const int sys_select = 93;
			const int sys_fsync = 95;
			const int sys_setpriority = 96;
			const int sys_socket = 97;
			const int sys_connect = 98;
			const int sys_accept = 99;
			const int sys_getpriority = 100;
			const int sys_send = 101;
			const int sys_recv = 102;
			const int sys_sigreturn = 103;
			const int sys_bind = 104;
			const int sys_setsockopt = 105;
			const int sys_listen = 106;
			const int sys_sigvec = 108;
			const int sys_sigblock = 109;
			const int sys_sigsetmask = 110;
			const int sys_sigsuspend = 111;
			const int sys_sigstack = 112;
			const int sys_recvmsg = 113;
			const int sys_sendmsg = 114;
			const int sys_gettimeofday = 116;
			const int sys_getrusage = 117;
			const int sys_getsockopt = 118;
			const int sys_readv = 120;
			const int sys_writev = 121;
			const int sys_settimeofday = 122;
			const int sys_fchown = 123;
			const int sys_fchmod = 124;
			const int sys_recvfrom = 125;
			const int sys_setreuid = 126;
			const int sys_setregid = 127;
			const int sys_rename = 128;
			const int sys_flock = 131;
			const int sys_mkfifo = 132;
			const int sys_sendto = 133;
			const int sys_shutdown = 134;
			const int sys_socketpair = 135;
			const int sys_mkdir = 136;
			const int sys_rmdir = 137;
			const int sys_utimes = 138;
			const int sys_adjtime = 140;
			const int sys_getpeername = 141;
			const int sys_gethostid = 142;
			const int sys_sethostid = 143;
			const int sys_getrlimit = 144;
			const int sys_setrlimit = 145;
			const int sys_killpg = 146;
			const int sys_setsid = 147;
			const int sys_quotactl = 148;
			const int sys_quota = 149;
			const int sys_getsockname = 150;
			const int sys_nlm_syscall = 154;
			const int sys_nfssvc = 155;
			const int sys_getdirentries = 156;
			const int sys_statfs = 157;
			const int sys_fstatfs = 158;
			const int sys_lgetfh = 160;
			const int sys_getfh = 161;
			const int sys_getdomainname = 162;
			const int sys_setdomainname = 163;
			const int sys_uname = 164;
			const int sys_sysarch = 165;
			const int sys_rtprio = 166;
			const int sys_semsys = 169;
			const int sys_setfib = 175;
			const int sys_ntp_adjtime = 176;
			const int sys_setgid = 181;
			const int sys_setegid = 182;
			const int sys_seteuid = 183;
			const int sys_stat = 188;
			const int sys_fstat = 189;
			const int sys_lstat = 190;
			const int sys_pathconf = 191;
			const int sys_fpathconf = 192;
			const int sys_getrlimit = 194;
			const int sys_setrlimit = 195;
			const int sys_getdirentries = 196;
			const int sys_nosys = 198;
			const int sys___sysctl = 202;
			const int sys_mlock = 203;
			const int sys_munlock = 204;
			const int sys_undelete = 205;
			const int sys_futimes = 206;
			const int sys_getpgid = 207;
			const int sys_poll = 209;
			const int sys___semctl = 220;
			const int sys_semget = 221;
			const int sys_semop = 222;
			const int sys_msgctl = 224;
			const int sys_msgget = 225;
			const int sys_msgsnd = 226;
			const int sys_msgrcv = 227;
			const int sys_shmctl = 229;
			const int sys_shmdt = 230;
			const int sys_shmget = 231;
			const int sys_clock_gettime = 232;
			const int sys_clock_settime = 233;
			const int sys_clock_getres = 234;
			const int sys_ktimer_create = 235;
			const int sys_ktimer_delete = 236;
			const int sys_ktimer_settime = 237;
			const int sys_ktimer_gettime = 238;
			const int sys_ktimer_getoverrun = 239;
			const int sys_nanosleep = 240;
			const int sys_ffclock_getcounter = 241;
			const int sys_ffclock_setestimate = 242;
			const int sys_ffclock_getestimate = 243;
			const int sys_clock_nanosleep = 244;
			const int sys_clock_getcpuclockid2 = 247;
			const int sys_ntp_gettime = 248;
			const int sys_minherit = 250;
			const int sys_rfork = 251;
			const int sys_issetugid = 253;
			const int sys_lchown = 254;
			const int sys_aio_read = 255;
			const int sys_aio_write = 256;
			const int sys_lio_listio = 257;
			const int sys_getdents = 272;
			const int sys_lchmod = 274;
			const int sys_lutimes = 276;
			const int sys_nstat = 278;
			const int sys_nfstat = 279;
			const int sys_nlstat = 280;
			const int sys_preadv = 289;
			const int sys_pwritev = 290;
			const int sys_fhstatfs = 297;
			const int sys_fhopen = 298;
			const int sys_fhstat = 299;
			const int sys_modnext = 300;
			const int sys_modstat = 301;
			const int sys_modfnext = 302;
			const int sys_modfind = 303;
			const int sys_kldload = 304;
			const int sys_kldunload = 305;
			const int sys_kldfind = 306;
			const int sys_kldnext = 307;
			const int sys_kldstat = 308;
			const int sys_kldfirstmod = 309;
			const int sys_getsid = 310;
			const int sys_setresuid = 311;
			const int sys_setresgid = 312;
			const int sys_aio_return = 314;
			const int sys_aio_suspend = 315;
			const int sys_aio_cancel = 316;
			const int sys_aio_error = 317;
			const int sys_aio_read = 318;
			const int sys_aio_write = 319;
			const int sys_lio_listio = 320;
			const int sys_yield = 321;
			const int sys_mlockall = 324;
			const int __getcwd = 325;
			const int sys_sched_setparam = 327;
			const int sys_sched_getparam = 328;
			const int sys_sched_setscheduler = 329;
			const int sys_sched_getscheduler = 330;
			const int sys_sched_yield = 331;
			const int sys_sched_get_priority_max = 332;
			const int sys_sched_get_priority_min = 333;
			const int sys_sched_rr_get_interval = 334;
			const int sys_utrace = 335;
			const int sys_sendfile = 336;
			const int sys_kldsym = 337;
			const int sys_jail = 338;
			const int sys_nnpfs_syscall = 339;
			const int sys_sigprocmask = 340;
			const int sys_sigsuspend = 341;
			const int sys_sigaction = 342;
			const int sys_sigpending = 343;
			const int sys_sigreturn = 344;
			const int sys_sigtimedwait = 345;
			const int sys_sigwaitinfo = 346;
			const int sys___acl_get_file = 347;
			const int sys___acl_set_file = 348;
			const int sys___acl_get_fd = 349;
			const int sys___acl_set_fd = 350;
			const int sys___acl_delete_file = 351;
			const int sys___acl_delete_fd = 352;
			const int sys___acl_aclcheck_file = 353;
			const int sys___acl_aclcheck_fd = 354;
			const int sys_extattrctl = 355;
			const int sys_extattr_set_file = 356;
			const int sys_extattr_get_file = 357;
			const int sys_extattr_delete_file = 358;
			const int sys_aio_waitcomplete = 359;
			const int sys_getresuid = 360;
			const int sys_getresgid = 361;
			const int sys_kqueue = 362;
			const int sys_kevent = 363;
			const int sys_extattr_set_fd = 371;
			const int sys_extattr_get_fd = 372;
			const int sys_extattr_delete_fd = 373;
			const int sys___setugid = 374;
			const int sys_eaccess = 376;
			const int sys_afs3_syscall = 377;
			const int sys_nmount = 378;
			const int sys___mac_get_proc = 384;
			const int sys___mac_set_proc = 385;
			const int sys___mac_get_fd = 386;
			const int sys___mac_get_file = 387;
			const int sys___mac_set_fd = 388;
			const int sys___mac_set_file = 389;
			const int sys_kenv = 390;
			const int sys_lchflags = 391;
			const int sys_uuidgen = 392;
			const int sys_sendfile = 393;
			const int sys_mac_syscall = 394;
			const int sys_getfsstat = 395;
			const int sys_statfs = 396;
			const int sys_fstatfs = 397;
			const int sys_fhstatfs = 398;
			const int sys_ksem_close = 400;
			const int sys_ksem_post = 401;
			const int sys_ksem_wait = 402;
			const int sys_ksem_trywait = 403;
			const int sys_ksem_init = 404;
			const int sys_ksem_open = 405;
			const int sys_ksem_unlink = 406;
			const int sys_ksem_getvalue = 407;
			const int sys_ksem_destroy = 408;
			const int sys___mac_get_pid = 409;
			const int sys___mac_get_link = 410;
			const int sys___mac_set_link = 411;
			const int sys_extattr_set_link = 412;
			const int sys_extattr_get_link = 413;
			const int sys_extattr_delete_link = 414;
			const int sys___mac_execve = 415;
			const int sys_sigaction = 416;
			const int sys_sigreturn = 417;
			const int sys_getcontext = 421;
			const int sys_setcontext = 422;
			const int sys_swapcontext = 423;
			const int sys_swapoff = 424;
			const int sys___acl_get_link = 425;
			const int sys___acl_set_link = 426;
			const int sys___acl_delete_link = 427;
			const int sys___acl_aclcheck_link = 428;
			const int sys_sigwait = 429;
			const int sys_thr_create = 430;
			const int sys_thr_exit = 431;
			const int sys_thr_self = 432;
			const int sys_thr_kill = 433;
			const int sys_jail_attach = 436;
			const int sys_extattr_list_fd = 437;
			const int sys_extattr_list_file = 438;
			const int sys_extattr_list_link = 439;
			const int sys_ksem_timedwait = 441;
			const int sys_thr_suspend = 442;
			const int sys_thr_wake = 443;
			const int sys_kldunloadf = 444;
			const int sys_audit = 445;
			const int sys_auditon = 446;
			const int sys_getauid = 447;
			const int sys_setauid = 448;
			const int sys_getaudit = 449;
			const int sys_setaudit = 450;
			const int sys_getaudit_addr = 451;
			const int sys_setaudit_addr = 452;
			const int sys_auditctl = 453;
			const int sys__umtx_op = 454;
			const int sys_thr_new = 455;
			const int sys_sigqueue = 456;
			const int sys_kmq_open = 457;
			const int sys_kmq_setattr = 458;
			const int sys_kmq_timedreceive = 459;
			const int sys_kmq_timedsend = 460;
			const int sys_kmq_notify = 461;
			const int sys_kmq_unlink = 462;
			const int sys_abort2 = 463;
			const int sys_thr_set_name = 464;
			const int sys_aio_fsync = 465;
			const int sys_rtprio_thread = 466;
			const int sys_sctp_peeloff = 471;
			const int sys_sctp_generic_sendmsg = 472;
			const int sys_sctp_generic_sendmsg_iov = 473;
			const int sys_sctp_generic_recvmsg = 474;
			const int sys_pread = 475;
			const int sys_pwrite = 476;
			const int sys_lseek = 478;
			const int sys_truncate = 479;
			const int sys_ftruncate = 480;
			const int sys_thr_kill2 = 481;
			const int sys_shm_open = 482;
			const int sys_shm_unlink = 483;
			const int sys_cpuset = 484;
			const int sys_cpuset_setid = 485;
			const int sys_cpuset_getid = 486;
			const int sys_cpuset_getaffinity = 487;
			const int sys_cpuset_setaffinity = 488;
			const int sys_faccessat = 489;
			const int sys_fchmodat = 490;
			const int sys_fchownat = 491;
			const int sys_fexecve = 492;
			const int sys_fstatat = 493;
			const int sys_futimesat = 494;
			const int sys_linkat = 495;
			const int sys_mkdirat = 496;
			const int sys_mkfifoat = 497;
			const int sys_mknodat = 498;
			const int sys_openat = 499;
			const int sys_readlinkat = 500;
			const int sys_renameat = 501;
			const int sys_symlinkat = 502;
			const int sys_unlinkat = 503;
			const int sys_posix_openpt = 504;
			const int sys_gssd_syscall = 505;
			const int sys_jail_get = 506;
			const int sys_jail_set = 507;
			const int sys_jail_remove = 508;
			const int sys_closefrom = 509;
			const int sys___semctl = 510;
			const int sys_msgctl = 511;
			const int sys_shmctl = 512;
			const int sys_lpathconf = 513;
			const int sys_cap_enter = 516;
			const int sys_cap_getmode = 517;
			const int sys_pdfork = 518;
			const int sys_pdkill = 519;
			const int sys_pdgetpid = 520;
			const int sys_pselect = 522;
			const int sys_getloginclass = 523;
			const int sys_setloginclass = 524;
			const int sys_rctl_get_racct = 525;
			const int sys_rctl_get_rules = 526;
			const int sys_rctl_get_limits = 527;
			const int sys_rctl_add_rule = 528;
			const int sys_rctl_remove_rule = 529;
			const int sys_posix_fallocate = 530;
			const int sys_posix_fadvise = 531;
			const int sys_wait6 = 532;
			const int sys_cap_rights_limit = 533;
			const int sys_cap_ioctls_limit = 534;
			const int sys_cap_ioctls_get = 535;
			const int sys_cap_fcntls_limit = 536;
			const int sys_cap_fcntls_get = 537;
			const int sys_bindat = 538;
			const int sys_connectat = 539;
			const int sys_chflagsat = 540;
			const int sys_accept4 = 541;
			const int sys_pipe2 = 542;
			const int sys_aio_mlock = 543;
			const int sys_procctl = 544;
			const int sys_ppoll = 545;
			const int sys_futimens = 546;
			const int sys_utimensat = 547;
			const int sys_fdatasync = 550;
			const int sys_fstat = 551;
			const int sys_fstatat = 552;
			const int sys_fhstat = 553;
			const int sys_getdirentries = 554;
			const int sys_statfs = 555;
			const int sys_fstatfs = 556;
			const int sys_getfsstat = 557;
			const int sys_fhstatfs = 558;
			const int sys_mknodat = 559;
			const int sys_kevent = 560;
			const int sys_cpuset_getdomain = 561;
			const int sys_cpuset_setdomain = 562;
			const int sys_getrandom = 563;
			const int sys_getfhat = 564;
			const int sys_fhlink = 565;
			const int sys_fhlinkat = 566;
			const int sys_fhreadlink = 567;
			const int sys_funlinkat = 568;
			const int sys_copy_file_range = 569;
			const int sys___sysctlbyname = 570;
			const int sys_shm_open2 = 571;
			const int sys_shm_rename = 572;
			const int sys_sigfastblock = 573;
			const int sys___realpathat = 574;
			const int sys_close_range = 575;
			const int sys_rpctls_syscall = 576;
		}
	}
}
#endif
