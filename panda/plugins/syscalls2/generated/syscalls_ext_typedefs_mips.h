...
typedef void (*on_create_module_enter_t)(CPUState* cpu, target_ulong pc, uint32_t name, uint32_t size);
typedef void (*on_create_module_return_t)(CPUState* cpu, target_ulong pc, uint32_t name, uint32_t size);
typedef void (*on_get_kernel_syms_enter_t)(CPUState* cpu, target_ulong pc, uint32_t table);
typedef void (*on_get_kernel_syms_return_t)(CPUState* cpu, target_ulong pc, uint32_t table);
typedef void (*on_mmap2_enter_t)(CPUState* cpu, target_ulong pc, uint32_t addr, uint32_t length, int32_t prot, int32_t flags, int32_t fd, uint32_t pgoffset);
typedef void (*on_mmap2_return_t)(CPUState* cpu, target_ulong pc, uint32_t addr, uint32_t length, int32_t prot, int32_t flags, int32_t fd, uint32_t pgoffset);
typedef void (*on_modify_ldt_enter_t)(CPUState* cpu, target_ulong pc, int32_t func, uint32_t ptr, uint32_t bytecount);
typedef void (*on_modify_ldt_return_t)(CPUState* cpu, target_ulong pc, int32_t func, uint32_t ptr, uint32_t bytecount);
typedef void (*on_set_thread_area_enter_t)(CPUState* cpu, target_ulong pc, uint32_t tp);
typedef void (*on_set_thread_area_return_t)(CPUState* cpu, target_ulong pc, uint32_t tp);
...
typedef void (*on_sys_adjtimex_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t txc_p);
typedef void (*on_sys_adjtimex_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t txc_p);
...
typedef void (*on_sys_cacheflush_enter_t)(CPUState* cpu, target_ulong pc, uint32_t addr, int32_t nbytes, int32_t cache);
typedef void (*on_sys_cacheflush_return_t)(CPUState* cpu, target_ulong pc, uint32_t addr, int32_t nbytes, int32_t cache);
...
typedef void (*on_sys_clock_adjtime32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t which_clock, uint32_t tx);
typedef void (*on_sys_clock_adjtime32_return_t)(CPUState* cpu, target_ulong pc, uint32_t which_clock, uint32_t tx);
...
typedef void (*on_sys_clock_getres_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t which_clock, uint32_t tp);
typedef void (*on_sys_clock_getres_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t which_clock, uint32_t tp);
...
typedef void (*on_sys_clock_gettime32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t which_clock, uint32_t tp);
typedef void (*on_sys_clock_gettime32_return_t)(CPUState* cpu, target_ulong pc, uint32_t which_clock, uint32_t tp);
...
typedef void (*on_sys_clock_nanosleep_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t which_clock, int32_t flags, uint32_t rqtp, uint32_t rmtp);
typedef void (*on_sys_clock_nanosleep_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t which_clock, int32_t flags, uint32_t rqtp, uint32_t rmtp);
...
typedef void (*on_sys_clock_settime32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t which_clock, uint32_t tp);
typedef void (*on_sys_clock_settime32_return_t)(CPUState* cpu, target_ulong pc, uint32_t which_clock, uint32_t tp);
...
typedef void (*on_sys_faccessat2_enter_t)(CPUState* cpu, target_ulong pc, int32_t dfd, uint32_t filename, int32_t mode, int32_t flags);
typedef void (*on_sys_faccessat2_return_t)(CPUState* cpu, target_ulong pc, int32_t dfd, uint32_t filename, int32_t mode, int32_t flags);
...
typedef void (*on_sys_fsconfig_enter_t)(CPUState* cpu, target_ulong pc, int32_t fs_fd, uint32_t cmd, uint32_t key, uint32_t value, int32_t aux);
typedef void (*on_sys_fsconfig_return_t)(CPUState* cpu, target_ulong pc, int32_t fs_fd, uint32_t cmd, uint32_t key, uint32_t value, int32_t aux);
...
typedef void (*on_sys_fsmount_enter_t)(CPUState* cpu, target_ulong pc, int32_t fs_fd, uint32_t flags, uint32_t ms_flags);
typedef void (*on_sys_fsmount_return_t)(CPUState* cpu, target_ulong pc, int32_t fs_fd, uint32_t flags, uint32_t ms_flags);
typedef void (*on_sys_fsopen_enter_t)(CPUState* cpu, target_ulong pc, uint32_t fs_name, uint32_t flags);
typedef void (*on_sys_fsopen_return_t)(CPUState* cpu, target_ulong pc, uint32_t fs_name, uint32_t flags);
typedef void (*on_sys_fspick_enter_t)(CPUState* cpu, target_ulong pc, int32_t dfd, uint32_t path, uint32_t flags);
typedef void (*on_sys_fspick_return_t)(CPUState* cpu, target_ulong pc, int32_t dfd, uint32_t path, uint32_t flags);
...
typedef void (*on_sys_futex_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t uaddr, int32_t op, uint32_t val, uint32_t utime, uint32_t uaddr2, uint32_t val3);
typedef void (*on_sys_futex_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t uaddr, int32_t op, uint32_t val, uint32_t utime, uint32_t uaddr2, uint32_t val3);
typedef void (*on_sys_futimesat_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t dfd, uint32_t filename, uint32_t t);
typedef void (*on_sys_futimesat_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t dfd, uint32_t filename, uint32_t t);
...
typedef void (*on_sys_idle_enter_t)(CPUState* cpu, target_ulong pc);
typedef void (*on_sys_idle_return_t)(CPUState* cpu, target_ulong pc);
...
typedef void (*on_sys_io_getevents_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t ctx_id, int32_t min_nr, int32_t nr, uint32_t events, uint32_t timeout);
typedef void (*on_sys_io_getevents_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t ctx_id, int32_t min_nr, int32_t nr, uint32_t events, uint32_t timeout);
typedef void (*on_sys_io_pgetevents_enter_t)(CPUState* cpu, target_ulong pc, uint32_t ctx_id, int32_t min_nr, int32_t nr, uint32_t events, uint32_t timeout, uint32_t sig);
typedef void (*on_sys_io_pgetevents_return_t)(CPUState* cpu, target_ulong pc, uint32_t ctx_id, int32_t min_nr, int32_t nr, uint32_t events, uint32_t timeout, uint32_t sig);
typedef void (*on_sys_io_pgetevents_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t ctx_id, int32_t min_nr, int32_t nr, uint32_t events, uint32_t timeout, uint32_t sig);
typedef void (*on_sys_io_pgetevents_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t ctx_id, int32_t min_nr, int32_t nr, uint32_t events, uint32_t timeout, uint32_t sig);
...
typedef void (*on_sys_io_uring_enter_enter_t)(CPUState* cpu, target_ulong pc, uint32_t fd, uint32_t to_submit, uint32_t min_complete, uint32_t flags, uint32_t sig, uint32_t sigsz);
typedef void (*on_sys_io_uring_enter_return_t)(CPUState* cpu, target_ulong pc, uint32_t fd, uint32_t to_submit, uint32_t min_complete, uint32_t flags, uint32_t sig, uint32_t sigsz);
typedef void (*on_sys_io_uring_register_enter_t)(CPUState* cpu, target_ulong pc, uint32_t fd, uint32_t op, uint32_t arg, uint32_t nr_args);
typedef void (*on_sys_io_uring_register_return_t)(CPUState* cpu, target_ulong pc, uint32_t fd, uint32_t op, uint32_t arg, uint32_t nr_args);
typedef void (*on_sys_io_uring_setup_enter_t)(CPUState* cpu, target_ulong pc, uint32_t entries, uint32_t p);
typedef void (*on_sys_io_uring_setup_return_t)(CPUState* cpu, target_ulong pc, uint32_t entries, uint32_t p);
...
typedef void (*on_sys_mmap_enter_t)(CPUState* cpu, target_ulong pc, uint32_t addr, uint32_t len, uint32_t prot, uint32_t flags, uint32_t fd, uint32_t pgoff);
typedef void (*on_sys_mmap_return_t)(CPUState* cpu, target_ulong pc, uint32_t addr, uint32_t len, uint32_t prot, uint32_t flags, uint32_t fd, uint32_t pgoff);
...
typedef void (*on_sys_move_mount_enter_t)(CPUState* cpu, target_ulong pc, int32_t from_dfd, uint32_t from_path, int32_t to_dfd, uint32_t to_path, uint32_t ms_flags);
typedef void (*on_sys_move_mount_return_t)(CPUState* cpu, target_ulong pc, int32_t from_dfd, uint32_t from_path, int32_t to_dfd, uint32_t to_path, uint32_t ms_flags);
...
typedef void (*on_sys_mq_timedreceive_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t mqdes, uint32_t u_msg_ptr, uint32_t msg_len, uint32_t u_msg_prio, uint32_t u_abs_timeout);
typedef void (*on_sys_mq_timedreceive_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t mqdes, uint32_t u_msg_ptr, uint32_t msg_len, uint32_t u_msg_prio, uint32_t u_abs_timeout);
...
typedef void (*on_sys_mq_timedsend_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t mqdes, uint32_t u_msg_ptr, uint32_t msg_len, uint32_t msg_prio, uint32_t u_abs_timeout);
typedef void (*on_sys_mq_timedsend_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t mqdes, uint32_t u_msg_ptr, uint32_t msg_len, uint32_t msg_prio, uint32_t u_abs_timeout);
...
typedef void (*on_sys_nanosleep_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t rqtp, uint32_t rmtp);
typedef void (*on_sys_nanosleep_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t rqtp, uint32_t rmtp);
...
typedef void (*on_sys_nfsservctl_enter_t)(CPUState* cpu, target_ulong pc, int32_t cmd, uint32_t argp, uint32_t resp);
typedef void (*on_sys_nfsservctl_return_t)(CPUState* cpu, target_ulong pc, int32_t cmd, uint32_t argp, uint32_t resp);
...
typedef void (*on_sys_open_tree_enter_t)(CPUState* cpu, target_ulong pc, int32_t dfd, uint32_t path, uint32_t flags);
typedef void (*on_sys_open_tree_return_t)(CPUState* cpu, target_ulong pc, int32_t dfd, uint32_t path, uint32_t flags);
...
typedef void (*on_sys_openat2_enter_t)(CPUState* cpu, target_ulong pc, int32_t dfd, uint32_t filename, uint32_t how, uint32_t size);
typedef void (*on_sys_openat2_return_t)(CPUState* cpu, target_ulong pc, int32_t dfd, uint32_t filename, uint32_t how, uint32_t size);
...
typedef void (*on_sys_pidfd_getfd_enter_t)(CPUState* cpu, target_ulong pc, int32_t pidfd, int32_t fd, uint32_t flags);
typedef void (*on_sys_pidfd_getfd_return_t)(CPUState* cpu, target_ulong pc, int32_t pidfd, int32_t fd, uint32_t flags);
...
typedef void (*on_sys_pidfd_send_signal_enter_t)(CPUState* cpu, target_ulong pc, int32_t pidfd, int32_t sig, uint32_t info, uint32_t flags);
typedef void (*on_sys_pidfd_send_signal_return_t)(CPUState* cpu, target_ulong pc, int32_t pidfd, int32_t sig, uint32_t info, uint32_t flags);
...
typedef void (*on_sys_ppoll_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t arg0, uint32_t arg1, uint32_t arg2, uint32_t arg3, uint32_t arg4);
typedef void (*on_sys_ppoll_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t arg0, uint32_t arg1, uint32_t arg2, uint32_t arg3, uint32_t arg4);
...
typedef void (*on_sys_pselect6_time32_enter_t)(CPUState* cpu, target_ulong pc, int32_t arg0, uint32_t arg1, uint32_t arg2, uint32_t arg3, uint32_t arg4, uint32_t arg5);
typedef void (*on_sys_pselect6_time32_return_t)(CPUState* cpu, target_ulong pc, int32_t arg0, uint32_t arg1, uint32_t arg2, uint32_t arg3, uint32_t arg4, uint32_t arg5);
...
typedef void (*on_sys_query_module_enter_t)(CPUState* cpu, target_ulong pc, uint32_t name, int32_t which, uint32_t buf, uint32_t bufsize, uint32_t ret);
typedef void (*on_sys_query_module_return_t)(CPUState* cpu, target_ulong pc, uint32_t name, int32_t which, uint32_t buf, uint32_t bufsize, uint32_t ret);
...
typedef void (*on_sys_recvmmsg_time32_enter_t)(CPUState* cpu, target_ulong pc, int32_t fd, uint32_t msg, uint32_t vlen, uint32_t flags, uint32_t timeout);
typedef void (*on_sys_recvmmsg_time32_return_t)(CPUState* cpu, target_ulong pc, int32_t fd, uint32_t msg, uint32_t vlen, uint32_t flags, uint32_t timeout);
...
typedef void (*on_sys_rseq_enter_t)(CPUState* cpu, target_ulong pc, uint32_t rseq, int32_t rseq_len, int32_t flags, int32_t sig);
typedef void (*on_sys_rseq_return_t)(CPUState* cpu, target_ulong pc, uint32_t rseq, int32_t rseq_len, int32_t flags, int32_t sig);
...
typedef void (*on_sys_rt_sigtimedwait_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t uthese, uint32_t uinfo, uint32_t uts, uint32_t sigsetsize);
typedef void (*on_sys_rt_sigtimedwait_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t uthese, uint32_t uinfo, uint32_t uts, uint32_t sigsetsize);
...
typedef void (*on_sys_sched_rr_get_interval_time32_enter_t)(CPUState* cpu, target_ulong pc, int32_t pid, uint32_t interval);
typedef void (*on_sys_sched_rr_get_interval_time32_return_t)(CPUState* cpu, target_ulong pc, int32_t pid, uint32_t interval);
...
typedef void (*on_sys_setup_enter_t)(CPUState* cpu, target_ulong pc);
typedef void (*on_sys_setup_return_t)(CPUState* cpu, target_ulong pc);
...
typedef void (*on_sys_sigpending_enter_t)(CPUState* cpu, target_ulong pc, uint32_t uset);
typedef void (*on_sys_sigpending_return_t)(CPUState* cpu, target_ulong pc, uint32_t uset);
...
typedef void (*on_sys_stime32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t tptr);
typedef void (*on_sys_stime32_return_t)(CPUState* cpu, target_ulong pc, uint32_t tptr);
...
typedef void (*on_sys_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t tloc);
typedef void (*on_sys_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t tloc);
...
typedef void (*on_sys_timer_gettime32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t timer_id, uint32_t setting);
typedef void (*on_sys_timer_gettime32_return_t)(CPUState* cpu, target_ulong pc, uint32_t timer_id, uint32_t setting);
...
typedef void (*on_sys_timer_settime32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t timer_id, int32_t flags, uint32_t _new, uint32_t old);
typedef void (*on_sys_timer_settime32_return_t)(CPUState* cpu, target_ulong pc, uint32_t timer_id, int32_t flags, uint32_t _new, uint32_t old);
...
typedef void (*on_sys_timerfd_gettime32_enter_t)(CPUState* cpu, target_ulong pc, int32_t ufd, uint32_t otmr);
typedef void (*on_sys_timerfd_gettime32_return_t)(CPUState* cpu, target_ulong pc, int32_t ufd, uint32_t otmr);
...
typedef void (*on_sys_timerfd_settime32_enter_t)(CPUState* cpu, target_ulong pc, int32_t ufd, int32_t flags, uint32_t utmr, uint32_t otmr);
typedef void (*on_sys_timerfd_settime32_return_t)(CPUState* cpu, target_ulong pc, int32_t ufd, int32_t flags, uint32_t utmr, uint32_t otmr);
...
typedef void (*on_sys_utime32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t filename, uint32_t t);
typedef void (*on_sys_utime32_return_t)(CPUState* cpu, target_ulong pc, uint32_t filename, uint32_t t);
...
typedef void (*on_sys_utimensat_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t dfd, uint32_t filename, uint32_t t, int32_t flags);
typedef void (*on_sys_utimensat_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t dfd, uint32_t filename, uint32_t t, int32_t flags);
typedef void (*on_sys_utimes_time32_enter_t)(CPUState* cpu, target_ulong pc, uint32_t filename, uint32_t t);
typedef void (*on_sys_utimes_time32_return_t)(CPUState* cpu, target_ulong pc, uint32_t filename, uint32_t t);
