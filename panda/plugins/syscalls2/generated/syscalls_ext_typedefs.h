...
typedef void (*on_sys_kcmp_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid1, uint32_t pid2, int32_t type, uint32_t idx1, uint32_t idx2);
typedef void (*on_sys_kcmp_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid1, uint32_t pid2, int32_t type, uint32_t idx1, uint32_t idx2);
...
typedef void (*on_sys_sched_getattr_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint32_t attr, uint32_t size, uint32_t flags);
typedef void (*on_sys_sched_getattr_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint32_t attr, uint32_t size, uint32_t flags);
...
typedef void (*on_sys_sched_setattr_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint32_t attr, uint32_t flags);
typedef void (*on_sys_sched_setattr_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint32_t attr, uint32_t flags);
...
typedef void (*on_sys_ioprio_set_enter_t)(CPUState* cpu, target_ulong pc, int32_t which, int32_t who, int32_t ioprio);
typedef void (*on_sys_ioprio_set_return_t)(CPUState* cpu, target_ulong pc, int32_t which, int32_t who, int32_t ioprio);
typedef void (*on_sys_kcmp_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid1, uint32_t pid2, int32_t type, uint64_t idx1, uint64_t idx2);
typedef void (*on_sys_kcmp_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid1, uint32_t pid2, int32_t type, uint64_t idx1, uint64_t idx2);
...
typedef void (*on_sys_kill_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, int32_t sig);
typedef void (*on_sys_kill_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, int32_t sig);
...
typedef void (*on_sys_migrate_pages_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t maxnode, uint64_t from, uint64_t to);
typedef void (*on_sys_migrate_pages_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t maxnode, uint64_t from, uint64_t to);
...
typedef void (*on_sys_move_pages_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t nr_pages, uint64_t pages, uint64_t nodes, uint64_t status, int32_t flags);
typedef void (*on_sys_move_pages_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t nr_pages, uint64_t pages, uint64_t nodes, uint64_t status, int32_t flags);
...
typedef void (*on_sys_pause_enter_t)(CPUState* cpu, target_ulong pc);
typedef void (*on_sys_pause_return_t)(CPUState* cpu, target_ulong pc);
typedef void (*on_sys_perf_event_open_enter_t)(CPUState* cpu, target_ulong pc, uint64_t attr_uptr, uint32_t pid, int32_t _cpu, int32_t group_fd, uint64_t flags);
typedef void (*on_sys_perf_event_open_return_t)(CPUState* cpu, target_ulong pc, uint64_t attr_uptr, uint32_t pid, int32_t _cpu, int32_t group_fd, uint64_t flags);
typedef void (*on_sys_personality_enter_t)(CPUState* cpu, target_ulong pc, uint32_t personality);
typedef void (*on_sys_personality_return_t)(CPUState* cpu, target_ulong pc, uint32_t personality);
...
typedef void (*on_sys_prlimit64_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint32_t resource, uint64_t new_rlim, uint64_t old_rlim);
typedef void (*on_sys_prlimit64_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint32_t resource, uint64_t new_rlim, uint64_t old_rlim);
typedef void (*on_sys_process_vm_readv_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t lvec, uint64_t liovcnt, uint64_t rvec, uint64_t riovcnt, uint64_t flags);
typedef void (*on_sys_process_vm_readv_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t lvec, uint64_t liovcnt, uint64_t rvec, uint64_t riovcnt, uint64_t flags);
typedef void (*on_sys_process_vm_writev_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t lvec, uint64_t liovcnt, uint64_t rvec, uint64_t riovcnt, uint64_t flags);
typedef void (*on_sys_process_vm_writev_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t lvec, uint64_t liovcnt, uint64_t rvec, uint64_t riovcnt, uint64_t flags);
...
typedef void (*on_sys_rt_sigqueueinfo_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, int32_t sig, uint64_t uinfo);
typedef void (*on_sys_rt_sigqueueinfo_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, int32_t sig, uint64_t uinfo);
...
typedef void (*on_sys_rt_tgsigqueueinfo_enter_t)(CPUState* cpu, target_ulong pc, uint32_t tgid, uint32_t pid, int32_t sig, uint64_t uinfo);
typedef void (*on_sys_rt_tgsigqueueinfo_return_t)(CPUState* cpu, target_ulong pc, uint32_t tgid, uint32_t pid, int32_t sig, uint64_t uinfo);
typedef void (*on_sys_sched_get_priority_max_enter_t)(CPUState* cpu, target_ulong pc, int32_t policy);
typedef void (*on_sys_sched_get_priority_max_return_t)(CPUState* cpu, target_ulong pc, int32_t policy);
typedef void (*on_sys_sched_get_priority_min_enter_t)(CPUState* cpu, target_ulong pc, int32_t policy);
typedef void (*on_sys_sched_get_priority_min_return_t)(CPUState* cpu, target_ulong pc, int32_t policy);
typedef void (*on_sys_sched_getaffinity_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint32_t len, uint64_t user_mask_ptr);
typedef void (*on_sys_sched_getaffinity_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint32_t len, uint64_t user_mask_ptr);
typedef void (*on_sys_sched_getattr_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t attr, uint32_t size, uint32_t flags);
typedef void (*on_sys_sched_getattr_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t attr, uint32_t size, uint32_t flags);
typedef void (*on_sys_sched_getparam_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t param);
typedef void (*on_sys_sched_getparam_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t param);
typedef void (*on_sys_sched_getscheduler_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid);
typedef void (*on_sys_sched_getscheduler_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid);
typedef void (*on_sys_sched_rr_get_interval_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t interval);
typedef void (*on_sys_sched_rr_get_interval_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t interval);
typedef void (*on_sys_sched_setaffinity_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint32_t len, uint64_t user_mask_ptr);
typedef void (*on_sys_sched_setaffinity_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint32_t len, uint64_t user_mask_ptr);
typedef void (*on_sys_sched_setattr_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t attr, uint32_t flags);
typedef void (*on_sys_sched_setattr_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t attr, uint32_t flags);
typedef void (*on_sys_sched_setparam_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t param);
typedef void (*on_sys_sched_setparam_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t param);
typedef void (*on_sys_sched_setscheduler_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, int32_t policy, uint64_t param);
typedef void (*on_sys_sched_setscheduler_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, int32_t policy, uint64_t param);
typedef void (*on_sys_sched_yield_enter_t)(CPUState* cpu, target_ulong pc);
typedef void (*on_sys_sched_yield_return_t)(CPUState* cpu, target_ulong pc);
...
typedef void (*on_sys_tee_enter_t)(CPUState* cpu, target_ulong pc, int32_t fdin, int32_t fdout, uint32_t len, uint32_t flags);
typedef void (*on_sys_tee_return_t)(CPUState* cpu, target_ulong pc, int32_t fdin, int32_t fdout, uint32_t len, uint32_t flags);
typedef void (*on_sys_tgkill_enter_t)(CPUState* cpu, target_ulong pc, uint32_t tgid, uint32_t pid, int32_t sig);
typedef void (*on_sys_tgkill_return_t)(CPUState* cpu, target_ulong pc, uint32_t tgid, uint32_t pid, int32_t sig);
...
typedef void (*on_sys_tkill_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, int32_t sig);
typedef void (*on_sys_tkill_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, int32_t sig);
...
typedef void (*on_sys_wait4_enter_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t stat_addr, int32_t options, uint64_t ru);
typedef void (*on_sys_wait4_return_t)(CPUState* cpu, target_ulong pc, uint32_t pid, uint64_t stat_addr, int32_t options, uint64_t ru);
typedef void (*on_sys_waitid_enter_t)(CPUState* cpu, target_ulong pc, int32_t which, uint32_t pid, uint64_t infop, int32_t options, uint64_t ru);
typedef void (*on_sys_waitid_return_t)(CPUState* cpu, target_ulong pc, int32_t which, uint32_t pid, uint64_t infop, int32_t options, uint64_t ru);
