...
void syscall_enter_switch_linux_arm ( CPUState *cpu, target_ulong pc ) {  // osarch
...
default:
PPP_RUN_CB(on_unknown_sys_enter, cpu, pc, env->regs[7]);
}
PPP_RUN_CB(on_all_sys_enter, cpu, pc, env->regs[7]);
