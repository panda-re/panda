...
#define FOREACH_CALLSITE(ACTION) \
    ACTION(RR_CALLSITE_DEFAULT_IOPORT_READW), \
    ACTION(RR_CALLSITE_CPU_INB), \
    ACTION(RR_CALLSITE_CPU_INW), \
    ACTION(RR_CALLSITE_CPU_INL), \
    ACTION(RR_CALLSITE_CPU_PHYSICAL_MEMORY_RW_1), \
    ACTION(RR_CALLSITE_CPU_PHYSICAL_MEMORY_RW_2), \
    ACTION(RR_CALLSITE_CPU_PHYSICAL_MEMORY_RW_3), \
    ACTION(RR_CALLSITE_CPU_PHYSICAL_MEMORY_RW_4), \
    ACTION(RR_CALLSITE_CPU_PHYSICAL_MEMORY_UNMAP), \
    ACTION(RR_CALLSITE_LDL_PHYS), \
    ACTION(RR_CALLSITE_LDQ_PHYS), \
    ACTION(RR_CALLSITE_IO_READ_ALL), \
    ACTION(RR_CALLSITE_IO_WRITE_ALL), \
    ACTION(RR_CALLSITE_IO_READ_0), \
    ACTION(RR_CALLSITE_IO_READ_1), \
    ACTION(RR_CALLSITE_IO_READ_2), \
    ACTION(RR_CALLSITE_IO_READ_3), \
    ACTION(RR_CALLSITE_WAIT_IO_EVENT), \
    ACTION(RR_CALLSITE_CPU_EXEC_0), \
    ACTION(RR_CALLSITE_CPU_EXEC_00), \
    ACTION(RR_CALLSITE_CPU_EXEC_000), \
    ACTION(RR_CALLSITE_CPU_HANDLE_INTERRUPT_BEFORE), \
    ACTION(RR_CALLSITE_CPU_HANDLE_INTERRUPT_INTNO), \
    ACTION(RR_CALLSITE_CPU_EXEC_3), \
    ACTION(RR_CALLSITE_CPU_HANDLE_INTERRUPT_AFTER), \
    ACTION(RR_CALLSITE_CPU_EXEC_DBG), \
    ACTION(RR_CALLSITE_CPU_HALTED), \
    ACTION(RR_CALLSITE_RDTSC), \
    ACTION(RR_CALLSITE_TB_INVALIDATE_PHYS_PAGE_RANGE), \
    ACTION(RR_CALLSITE_CPU_OUTB), \
    ACTION(RR_CALLSITE_CPU_OUTW), \
    ACTION(RR_CALLSITE_CPU_OUTL), \
    ACTION(RR_CALLSITE_IO_WRITE_0), \
    ACTION(RR_CALLSITE_IO_WRITE_1), \
    ACTION(RR_CALLSITE_IO_WRITE_2), \
    ACTION(RR_CALLSITE_IO_WRITE_3), \
    ACTION(RR_CALLSITE_DEFAULT_IOPORT_WRITEW), \
    ACTION(RR_CALLSITE_MAIN_LOOP), \
    ACTION(RR_CALLSITE_MAIN_LOOP_WAIT), \
    ACTION(RR_CALLSITE_PHYS_MEM_IO_1), \
    ACTION(RR_CALLSITE_PHYS_MEM_IO_2), \
    ACTION(RR_CALLSITE_PHYS_MEM_IO_3), \
    ACTION(RR_CALLSITE_STL_PHYS_ND), \
    ACTION(RR_CALLSITE_STQ_PHYS_ND), \
    ACTION(RR_CALLSITE_STL_PHYS), \
    ACTION(RR_CALLSITE_DO_SMM_ENTER), \
    ACTION(RR_CALLSITE_HELPER_RSM), \
    ACTION(RR_CALLSITE_IOPORT_READ), \
    ACTION(RR_CALLSITE_IOPORT_WRITE), \
    ACTION(RR_CALLSITE_SPARC_CPU_EXEC_1), \
    ACTION(RR_CALLSITE_MIPS_CPU_EXEC_1), \
    ACTION(RR_CALLSITE_IDE_SECTOR_READ), \
    ACTION(RR_CALLSITE_IDE_SECTOR_WRITE), \
    ACTION(RR_CALLSITE_IDE_DMA_CB), \
    ...
    ACTION(RR_CALLSITE_ADDRESS_SPACE_READ_CONTINUE_8), \
    ACTION(RR_CALLSITE_ADDRESS_SPACE_READ_CONTINUE_4), \
    ACTION(RR_CALLSITE_ADDRESS_SPACE_READ_CONTINUE_2), \
    ACTION(RR_CALLSITE_ADDRESS_SPACE_READ_CONTINUE_1), \
    ACTION(RR_CALLSITE_ADDRESS_SPACE_LDL_INTERNAL), \
    ACTION(RR_CALLSITE_ADDRESS_SPACE_LDQ_INTERNAL), \
    ACTION(RR_CALLSITE_ADDRESS_SPACE_LDUW_INTERNAL), \
    ACTION(RR_CALLSITE_STL_INTERNAL), \
    ACTION(RR_CALLSITE_STW_INTERNAL), \
    ACTION(RR_CALLSITE_ADDRESS_SPACE_WRITE_CONTINUE_8), \
