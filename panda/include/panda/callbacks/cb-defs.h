...
typedef union panda_cb {
    ...
    */
     ...
     */
    bool (*unassigned_io_read)(target_ptr_t pc, hwaddr addr, size_t size, uint64_t *val);
     ...
     */
    bool (*unassigned_io_write)(target_ptr_t pc, hwaddr addr, size_t size, uint64_t val);
