...
bool panda_callbacks_after_find_fast(TranslationBlock *tb, bool bb_invalidate_done, bool *invalidate);
...
//-AUTOGENERATED BEGIN-
/* invoked from TBA */
int panda_callbacks_insn_exec(target_ptr_t pc);
...
void panda_callbacks_after_loadvm(void);
...
bool panda_callbacks_unassigned_io_read(target_ptr_t pc, hwaddr addr, size_t size, uint64_t *val);
bool panda_callbacks_unassigned_io_write(target_ptr_t pc, hwaddr addr, size_t size, uint64_t val);
