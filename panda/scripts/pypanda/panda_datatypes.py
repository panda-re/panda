...
#Hook = recordclass("Hook", "is_enabled is_kernel hook_cb target_addr target_library_offset library_name program_name")
class Hook(object):
	def __init__(self, is_enabled=True, is_kernel=True,hook_cb=0,target_addr=0,target_library_offset=0,library_name=None,program_name=None):
