...
# 11 "/home/alom/git/panda/include/qemu/fprintf-fn.h"
...
{
    return ({ typedef struct { int:(sizeof(*&ctx->external_disable_cnt) > sizeof(void *)) ? -1 : 1; } qemu_build_bug_on__0 __attribute__((unused)); __atomic_load_n(&ctx->external_disable_cnt, 0); });
}
# 480 "/home/alom/git/panda/include/block/aio.h"
static inline bool aio_node_check(AioContext *ctx, bool is_external)
{
    return !is_external || !({ typedef struct { int:(sizeof(*&ctx->external_disable_cnt) > sizeof(void *)) ? -1 : 1; } qemu_build_bug_on__1 __attribute__((unused)); __atomic_load_n(&ctx->external_disable_cnt, 0); });
}
