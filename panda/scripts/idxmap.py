...
if len(sys.argv) != 3:
    print("usage: %s <tap_index> <offset_list>" % sys.argv[0], file=sys.stderr)
    print("  <offset_list> should be a file with offsets into the memory dump, one per line", file=sys.stderr)
    sys.exit(1)
