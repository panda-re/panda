...
from typing import IO, Callable, List, Union, Optional, Set, ByteString
...
class Panda():
    ...
    def _finish_timer(self, start, msg:str) -> None:
    ...
    def _setup_internal_signal_handler(self, signal_handler=None) -> None:
    ...
    def virtual_memory_write(self, cpu, addr:int, buf:int) -> int:
        '''
    ...
    def _memory_write(self, cpu, addr:int, buf:int, physical:bool=False) -> ByteString:
        '''
    ...
    def virt_to_phys(self, cpu, addr:int) -> int:
        '''
...
#            self.queue_main_loop_wait_fn(self.load_plugin, ["taint2"])
    ...
    @blocking
    def run_serial_cmd(self, cmd:str, no_timeout:bool=False, timeout:int=None):
        '''
    ...
    @blocking
    def copy_to_guest(self, copy_directory:str, iso_name:str=None, absolute_paths:bool=False, setup_script:str="setup.sh", timeout:int=None):
        '''
...
#        assert (not self.running.is_set()), "Can't finish while still running"
    ...
    def hook(self, addr:int, enabled:bool=True, kernel:Optional[bool]=None, asid:Optional[bool]=None, cb_type:str="start_block_exec"):
        '''
    ...
    def hook_symbol(self, libraryname:str, symbol:Union[int,str,None], kernel:bool=False, name:bool=None, cb_type:str="start_block_exec"):
        '''
        Decorate a function to setup a hook: when a guest goes to execute a basic block beginning with addr,
        the function will be called with args (CPUState, TranslationBlock)
