...
struct r4k_tlb_t {
	target_ulong               VPN;                  /*     0     8 */
	uint32_t                   PageMask;             /*     8     4 */
	uint16_t                   ASID;                 /*    12     2 */
	/* Bitfield combined with previous fields */
	unsigned int               G:1;                  /*    12:16  4 */
	unsigned int               C0:3;                 /*    12:17  4 */
	unsigned int               C1:3;                 /*    12:20  4 */
	unsigned int               V0:1;                 /*    12:23  4 */
	unsigned int               V1:1;                 /*    12:24  4 */
	unsigned int               D0:1;                 /*    12:25  4 */
	unsigned int               D1:1;                 /*    12:26  4 */
	unsigned int               XI0:1;                /*    12:27  4 */
	unsigned int               XI1:1;                /*    12:28  4 */
	unsigned int               RI0:1;                /*    12:29  4 */
	unsigned int               RI1:1;                /*    12:30  4 */
	unsigned int               EHINV:1;              /*    12:31  4 */
...
struct mips_def_t {
	...
	/* XXX 4 bytes hole, try to pack */
	target_ulong               CP0_LLAddr_rw_bitmask; /*    56     8 */
	/* --- cacheline 1 boundary (64 bytes) --- */
	int                        CP0_LLAddr_shift;     /*    64     4 */
	int32_t                    SYNCI_Step;           /*    68     4 */
	int32_t                    CCRes;                /*    72     4 */
	int32_t                    CP0_Status_rw_bitmask; /*    76     4 */
	int32_t                    CP0_TCStatus_rw_bitmask; /*    80     4 */
	int32_t                    CP0_SRSCtl;           /*    84     4 */
	int32_t                    CP1_fcr0;             /*    88     4 */
	int32_t                    CP1_fcr31_rw_bitmask; /*    92     4 */
	int32_t                    CP1_fcr31;            /*    96     4 */
	int32_t                    MSAIR;                /*   100     4 */
	int32_t                    SEGBITS;              /*   104     4 */
	int32_t                    PABITS;               /*   108     4 */
	int32_t                    CP0_SRSConf0_rw_bitmask; /*   112     4 */
	int32_t                    CP0_SRSConf0;         /*   116     4 */
	int32_t                    CP0_SRSConf1_rw_bitmask; /*   120     4 */
	int32_t                    CP0_SRSConf1;         /*   124     4 */
	/* --- cacheline 2 boundary (128 bytes) --- */
	int32_t                    CP0_SRSConf2_rw_bitmask; /*   128     4 */
	int32_t                    CP0_SRSConf2;         /*   132     4 */
	int32_t                    CP0_SRSConf3_rw_bitmask; /*   136     4 */
	int32_t                    CP0_SRSConf3;         /*   140     4 */
	int32_t                    CP0_SRSConf4_rw_bitmask; /*   144     4 */
	int32_t                    CP0_SRSConf4;         /*   148     4 */
	int32_t                    CP0_PageGrain_rw_bitmask; /*   152     4 */
	int32_t                    CP0_PageGrain;        /*   156     4 */
	int                        insn_flags;           /*   160     4 */
	enum mips_mmu_types mmu_type;                    /*   164     4 */
	/* size: 168, cachelines: 3, members: 39 */
...
struct TCState {
	...
	/* --- cacheline 4 boundary (256 bytes) --- */
	target_ulong               PC;                   /*   256     8 */
	target_ulong               HI[4];                /*   264    32 */
	target_ulong               LO[4];                /*   296    32 */
	/* --- cacheline 5 boundary (320 bytes) was 8 bytes ago --- */
	target_ulong               ACX[4];               /*   328    32 */
	target_ulong               DSPControl;           /*   360     8 */
	int32_t                    CP0_TCStatus;         /*   368     4 */
	int32_t                    CP0_TCBind;           /*   372     4 */
	target_ulong               CP0_TCHalt;           /*   376     8 */
	/* --- cacheline 6 boundary (384 bytes) --- */
	target_ulong               CP0_TCContext;        /*   384     8 */
	target_ulong               CP0_TCSchedule;       /*   392     8 */
	target_ulong               CP0_TCScheFBack;      /*   400     8 */
	int32_t                    CP0_Debug_tcstatus;   /*   408     4 */
	/* XXX 4 bytes hole, try to pack */
	target_ulong               CP0_UserLocal;        /*   416     8 */
	int32_t                    msacsr;               /*   424     4 */
	float_status               msa_fp_status;        /*   428     8 */
	/* size: 440, cachelines: 7, members: 16 */
...
struct CPUMIPSState {
	TCState                    active_tc;            /*     0   440 */
	/* --- cacheline 6 boundary (384 bytes) was 56 bytes ago --- */
	CPUMIPSFPUContext          active_fpu;           /*   440   536 */
	/* --- cacheline 15 boundary (960 bytes) was 16 bytes ago --- */
	uint32_t                   current_tc;           /*   976     4 */
	uint32_t                   current_fpu;          /*   980     4 */
	uint32_t                   SEGBITS;              /*   984     4 */
	uint32_t                   PABITS;               /*   988     4 */
	target_ulong               SEGMask;              /*   992     8 */
	uint64_t                   PAMask;               /*  1000     8 */
	int32_t                    msair;                /*  1008     4 */
	int32_t                    CP0_Index;            /*  1012     4 */
	int32_t                    CP0_VPControl;        /*  1016     4 */
	int32_t                    CP0_Random;           /*  1020     4 */
	/* --- cacheline 16 boundary (1024 bytes) --- */
	int32_t                    CP0_VPEControl;       /*  1024     4 */
	int32_t                    CP0_VPEConf0;         /*  1028     4 */
	int32_t                    CP0_VPEConf1;         /*  1032     4 */
	/* XXX 4 bytes hole, try to pack */
	target_ulong               CP0_YQMask;           /*  1040     8 */
	target_ulong               CP0_VPESchedule;      /*  1048     8 */
	target_ulong               CP0_VPEScheFBack;     /*  1056     8 */
	int32_t                    CP0_VPEOpt;           /*  1064     4 */
	/* XXX 4 bytes hole, try to pack */
	uint64_t                   CP0_EntryLo0;         /*  1072     8 */
	uint64_t                   CP0_EntryLo1;         /*  1080     8 */
	/* --- cacheline 17 boundary (1088 bytes) --- */
	int32_t                    CP0_GlobalNumber;     /*  1088     4 */
	/* XXX 4 bytes hole, try to pack */
	target_ulong               CP0_Context;          /*  1096     8 */
	target_ulong               CP0_KScratch[6];      /*  1104    48 */
	/* --- cacheline 18 boundary (1152 bytes) --- */
	int32_t                    CP0_PageMask;         /*  1152     4 */
	int32_t                    CP0_PageGrain_rw_bitmask; /*  1156     4 */
	int32_t                    CP0_PageGrain;        /*  1160     4 */
	int32_t                    CP0_Wired;            /*  1164     4 */
	int32_t                    CP0_SRSConf0_rw_bitmask; /*  1168     4 */
	int32_t                    CP0_SRSConf0;         /*  1172     4 */
	int32_t                    CP0_SRSConf1_rw_bitmask; /*  1176     4 */
	int32_t                    CP0_SRSConf1;         /*  1180     4 */
	int32_t                    CP0_SRSConf2_rw_bitmask; /*  1184     4 */
	int32_t                    CP0_SRSConf2;         /*  1188     4 */
	int32_t                    CP0_SRSConf3_rw_bitmask; /*  1192     4 */
	int32_t                    CP0_SRSConf3;         /*  1196     4 */
	int32_t                    CP0_SRSConf4_rw_bitmask; /*  1200     4 */
	int32_t                    CP0_SRSConf4;         /*  1204     4 */
	int32_t                    CP0_HWREna;           /*  1208     4 */
	/* XXX 4 bytes hole, try to pack */
	/* --- cacheline 19 boundary (1216 bytes) --- */
	target_ulong               CP0_BadVAddr;         /*  1216     8 */
	uint32_t                   CP0_BadInstr;         /*  1224     4 */
	uint32_t                   CP0_BadInstrP;        /*  1228     4 */
	int32_t                    CP0_Count;            /*  1232     4 */
	/* XXX 4 bytes hole, try to pack */
	target_ulong               CP0_EntryHi;          /*  1240     8 */
	target_ulong               CP0_EntryHi_ASID_mask; /*  1248     8 */
	int32_t                    CP0_Compare;          /*  1256     4 */
	int32_t                    CP0_Status;           /*  1260     4 */
	int32_t                    CP0_IntCtl;           /*  1264     4 */
	int32_t                    CP0_SRSCtl;           /*  1268     4 */
	int32_t                    CP0_SRSMap;           /*  1272     4 */
	int32_t                    CP0_Cause;            /*  1276     4 */
	/* --- cacheline 20 boundary (1280 bytes) --- */
	target_ulong               CP0_EPC;              /*  1280     8 */
	int32_t                    CP0_PRid;             /*  1288     4 */
	int32_t                    CP0_EBase;            /*  1292     4 */
	target_ulong               CP0_CMGCRBase;        /*  1296     8 */
	int32_t                    CP0_Config0;          /*  1304     4 */
	int32_t                    CP0_Config1;          /*  1308     4 */
	int32_t                    CP0_Config2;          /*  1312     4 */
	int32_t                    CP0_Config3;          /*  1316     4 */
	int32_t                    CP0_Config4;          /*  1320     4 */
	int32_t                    CP0_Config4_rw_bitmask; /*  1324     4 */
	int32_t                    CP0_Config5;          /*  1328     4 */
	int32_t                    CP0_Config5_rw_bitmask; /*  1332     4 */
	int32_t                    CP0_Config6;          /*  1336     4 */
	int32_t                    CP0_Config7;          /*  1340     4 */
	/* --- cacheline 21 boundary (1344 bytes) --- */
	uint64_t                   CP0_MAAR[16];         /*  1344   128 */
	/* --- cacheline 23 boundary (1472 bytes) --- */
	int32_t                    CP0_MAARI;            /*  1472     4 */
	/* XXX 4 bytes hole, try to pack */
	uint64_t                   lladdr;               /*  1480     8 */
	target_ulong               llval;                /*  1488     8 */
	target_ulong               llnewval;             /*  1496     8 */
	target_ulong               llreg;                /*  1504     8 */
	uint64_t                   CP0_LLAddr_rw_bitmask; /*  1512     8 */
	int                        CP0_LLAddr_shift;     /*  1520     4 */
	/* XXX 4 bytes hole, try to pack */
	target_ulong               CP0_WatchLo[8];       /*  1528    64 */
	/* --- cacheline 24 boundary (1536 bytes) was 56 bytes ago --- */
	int32_t                    CP0_WatchHi[8];       /*  1592    32 */
	/* --- cacheline 25 boundary (1600 bytes) was 24 bytes ago --- */
	target_ulong               CP0_XContext;         /*  1624     8 */
	int32_t                    CP0_Framemask;        /*  1632     4 */
	int32_t                    CP0_Debug;            /*  1636     4 */
	target_ulong               CP0_DEPC;             /*  1640     8 */
	int32_t                    CP0_Performance0;     /*  1648     4 */
	int32_t                    CP0_ErrCtl;           /*  1652     4 */
	uint64_t                   CP0_TagLo;            /*  1656     8 */
	/* --- cacheline 26 boundary (1664 bytes) --- */
	int32_t                    CP0_DataLo;           /*  1664     4 */
	int32_t                    CP0_TagHi;            /*  1668     4 */
	int32_t                    CP0_DataHi;           /*  1672     4 */
	/* XXX 4 bytes hole, try to pack */
	target_ulong               CP0_ErrorEPC;         /*  1680     8 */
	int32_t                    CP0_DESAVE;           /*  1688     4 */
	/* XXX 4 bytes hole, try to pack */
	TCState                    tcs[16];              /*  1696  7040 */
	/* --- cacheline 136 boundary (8704 bytes) was 32 bytes ago --- */
	CPUMIPSFPUContext          fpus[1];              /*  8736   536 */
	/* --- cacheline 144 boundary (9216 bytes) was 56 bytes ago --- */
	int                        error_code;           /*  9272     4 */
	uint32_t                   hflags;               /*  9276     4 */
	/* --- cacheline 145 boundary (9280 bytes) --- */
	target_ulong               btarget;              /*  9280     8 */
	target_ulong               bcond;                /*  9288     8 */
	int                        SYNCI_Step;           /*  9296     4 */
	int                        CCRes;                /*  9300     4 */
	uint32_t                   CP0_Status_rw_bitmask; /*  9304     4 */
	uint32_t                   CP0_TCStatus_rw_bitmask; /*  9308     4 */
	int                        insn_flags;           /*  9312     4 */
		                              /*  9316     0 */
	/* XXX 4 bytes hole, try to pack */
	CPUTLBEntry                tlb_table[3][256];    /*  9320 24576 */
	/* --- cacheline 529 boundary (33856 bytes) was 40 bytes ago --- */
	CPUTLBEntry                tlb_v_table[3][8];    /* 33896   768 */
	/* --- cacheline 541 boundary (34624 bytes) was 40 bytes ago --- */
	CPUIOTLBEntry              iotlb[3][256];        /* 34664 12288 */
	/* --- cacheline 733 boundary (46912 bytes) was 40 bytes ago --- */
	CPUIOTLBEntry              iotlb_v[3][8];        /* 46952   384 */
	/* --- cacheline 739 boundary (47296 bytes) was 40 bytes ago --- */
	target_ulong               tlb_flush_addr;       /* 47336     8 */
	target_ulong               tlb_flush_mask;       /* 47344     8 */
	target_ulong               vtlb_index;           /* 47352     8 */
	/* --- cacheline 740 boundary (47360 bytes) --- */
	CPUMIPSMVPContext *        mvp;                  /* 47360     8 */
	CPUMIPSTLBContext *        tlb;                  /* 47368     8 */
	const mips_def_t  *        cpu_model;            /* 47376     8 */
	void *                     irq[8];               /* 47384    64 */
	/* --- cacheline 741 boundary (47424 bytes) was 24 bytes ago --- */
	QEMUTimer *                timer;                /* 47448     8 */
	MemoryRegion *             itc_tag;              /* 47456     8 */
	target_ulong               exception_base;       /* 47464     8 */
	/* size: 47472, cachelines: 742, members: 113 */
	/* sum members: 47432, holes: 10, sum holes: 40 */
	/* last cacheline: 48 bytes */
};
struct CPUState;
typedef struct CPUState CPUState;
