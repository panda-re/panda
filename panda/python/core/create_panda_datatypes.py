...
<<<<<<< HEAD:panda/python/core/create_panda_datatypes.py
    #fname = copy_syscalls_header("%s/%s" % (syscalls_gen_dir, "syscalls_ext_typedefs.h")) # Common to all archs - Has problems
    #pypanda_headers.append(fname) # We always want to  include this
=======
>>>>>>> Better PPP interface for pypanda. Adds support for syscalls2 headers (only):panda/pypanda/utils/create_panda_datatypes.py
