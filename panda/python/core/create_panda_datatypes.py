...
def main(install=False):
    ...
    if install: # DYNAMIC from file
        INCLUDE_DIR_PYP_INSTALL = 'os.path.abspath(os.path.join(*[os.path.dirname(__file__), "..", "..", "panda", "data", "pypanda", "include"]))'  # ... /python3.6/site-packages/panda/data/pypanda/include/
    else:
        # STATIC from current
