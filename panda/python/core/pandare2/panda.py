...
class Panda():
    ...
    def __init__(self, arch="i386", mem="128M",
        ...
        from os.path import join
        self.panda_args += ['-plugin', pandummy_path]
    ...
    def _do_types_import(self):
        ...
        panda_arch_support = import_module(f".autogen.panda_{self.arch_name}_{self.bits}",package='pandare2')
    ...
    def _initialize_panda(self):
        ...
        self.libpanda.qemu_init(len_cargs, panda_args_ffi)
    ...
    def _find_build_dir(arch_name):
        ...
        raise RuntimeError(("Couldn't find libpanda_{}-softmmu.so.\n"
