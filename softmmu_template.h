                                          ...
                                          TCGMemOpIdx oi, uintptr_t retaddr)
{
    ...
    panda_callbacks_mem_before_read(cpu->panda_guest_pc, addr, DATA_SIZE, (void *)haddr);
    WORD_TYPE ret = helper_le_ld_name(env, addr, oi, retaddr);
    panda_callbacks_mem_after_read(cpu->panda_guest_pc, addr, DATA_SIZE, (uint64_t)ret, (void *)haddr);
    return ret;
}
                                     ...
                                     uintptr_t retaddr)
{
    ...
    panda_callbacks_mem_before_write(cpu->panda_guest_pc, addr, DATA_SIZE, (uint64_t)val, (void *)haddr);
    helper_le_st_name(env, addr, val, oi, retaddr);
    panda_callbacks_mem_after_write(cpu->panda_guest_pc, addr, DATA_SIZE, (uint64_t)val, (void *)haddr);
}
