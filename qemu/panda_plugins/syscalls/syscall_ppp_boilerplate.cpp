...
PPP_CB_BOILERPLATE(on_sys_mremap_returned)
...
PPP_CB_BOILERPLATE(on_sys_waitpid_returned)
PPP_CB_BOILERPLATE(on_sys_close)
PPP_CB_BOILERPLATE(on_sys_signal_returned)
PPP_CB_BOILERPLATE(on_sys_perf_event_open)
PPP_CB_BOILERPLATE(on_sys_preadv)
...
PPP_CB_BOILERPLATE(on_sys_fanotify_init_returned)
...
PPP_CB_BOILERPLATE(on_sys_recvmmsg_returned)
...
PPP_CB_BOILERPLATE(on_sys_ioperm_returned)
...
PPP_CB_BOILERPLATE(on_sys_sendmmsg_returned)
...
PPP_CB_BOILERPLATE(on_sys_fadvise64)
PPP_CB_BOILERPLATE(on_sys_mremap)
PPP_CB_BOILERPLATE(on_sys_mmap_pgoff)
...
PPP_CB_BOILERPLATE(on_sys_ioperm)
...
PPP_CB_BOILERPLATE(on_sys_utime_returned)
PPP_CB_BOILERPLATE(on_sys_sethostname_returned)
PPP_CB_BOILERPLATE(on_sys_setreuid_returned)
PPP_CB_BOILERPLATE(on_sys_sync_file_range_returned)
...
PPP_CB_BOILERPLATE(on_sys_epoll_pwait)
...
PPP_CB_BOILERPLATE(on_sys_stat)
...
PPP_CB_BOILERPLATE(on_sys_stat_returned)
...
PPP_CB_BOILERPLATE(on_sys_perf_event_open_returned)
...
PPP_CB_BOILERPLATE(on_sys_fadvise64_64_returned)
...
PPP_CB_BOILERPLATE(on_sys_setns)
...
PPP_CB_BOILERPLATE(on_sys_process_vm_writev)
...
PPP_CB_BOILERPLATE(on_sys_olduname)
...
PPP_CB_BOILERPLATE(on_sys_syncfs)
...
PPP_CB_BOILERPLATE(on_sys_old_getrlimit_returned)
PPP_CB_BOILERPLATE(on_sys_flock)
PPP_CB_BOILERPLATE(on_sys_mkdir_returned)
PPP_CB_BOILERPLATE(on_sys_futimesat)
PPP_CB_BOILERPLATE(on_sys_ssetmask_returned)
PPP_CB_BOILERPLATE(on_sys_pause)
PPP_CB_BOILERPLATE(on_sys_old_select)
PPP_CB_BOILERPLATE(on_sys_old_readdir_returned)
...
PPP_CB_BOILERPLATE(on_sys_migrate_pages_returned)
...
PPP_CB_BOILERPLATE(on_sys_fanotify_mark_returned)
...
PPP_CB_BOILERPLATE(on_sys_fanotify_mark)
...
PPP_CB_BOILERPLATE(on_sys_fanotify_init)
...
PPP_CB_BOILERPLATE(on_sys_process_vm_readv_returned)
PPP_CB_BOILERPLATE(on_sys_ipc)
PPP_CB_BOILERPLATE(on_sys_prlimit64_returned)
...
PPP_CB_BOILERPLATE(on_sys_syncfs_returned)
...
PPP_CB_BOILERPLATE(on_sys_fstat_returned)
...
PPP_CB_BOILERPLATE(on_sys_process_vm_readv)
PPP_CB_BOILERPLATE(on_sys_chroot)
PPP_CB_BOILERPLATE(on_sys_rt_tgsigqueueinfo_returned)
...
PPP_CB_BOILERPLATE(on_sys_pselect6_returned)
...
PPP_CB_BOILERPLATE(on_sys_alarm_returned)
...
PPP_CB_BOILERPLATE(on_sys_old_mmap_returned)
...
PPP_CB_BOILERPLATE(on_sys_utime)
PPP_CB_BOILERPLATE(on_sys_name_to_handle_at)
PPP_CB_BOILERPLATE(on_sys_adjtimex)
PPP_CB_BOILERPLATE(on_sys_old_getrlimit)
...
PPP_CB_BOILERPLATE(on_sys_process_vm_writev_returned)
...
PPP_CB_BOILERPLATE(on_sys_epoll_pwait_returned)
PPP_CB_BOILERPLATE(on_sys_fadvise64_64)
...
PPP_CB_BOILERPLATE(on_sys_alarm)
...
PPP_CB_BOILERPLATE(on_sys_fstat)
...
PPP_CB_BOILERPLATE(on_sys_socketcall_returned)
PPP_CB_BOILERPLATE(on_sys_gettid_returned)
PPP_CB_BOILERPLATE(on_sys_recvmmsg)
PPP_CB_BOILERPLATE(on_sys_renameat_returned)
PPP_CB_BOILERPLATE(on_sys_open_by_handle_at_returned)
PPP_CB_BOILERPLATE(on_sys_ppoll)
PPP_CB_BOILERPLATE(on_sys_timerfd_create)
PPP_CB_BOILERPLATE(on_sys_umount)
PPP_CB_BOILERPLATE(on_sys_stime)
...
PPP_CB_BOILERPLATE(on_sys_time_returned)
PPP_CB_BOILERPLATE(on_sys_inotify_rm_watch)
PPP_CB_BOILERPLATE(on_sys_ipc_returned)
...
PPP_CB_BOILERPLATE(on_sys_lstat_returned)
...
PPP_CB_BOILERPLATE(on_sys_sgetmask_returned)
...
PPP_CB_BOILERPLATE(on_sys_old_mmap)
PPP_CB_BOILERPLATE(on_sys_rt_sigpending)
PPP_CB_BOILERPLATE(on_sys_oldumount_returned)
PPP_CB_BOILERPLATE(on_sys_getegid16_returned)
PPP_CB_BOILERPLATE(on_rt_sigaction_returned)
PPP_CB_BOILERPLATE(on_sys_pwritev_returned)
PPP_CB_BOILERPLATE(on_sys_oldumount)
...
PPP_CB_BOILERPLATE(on_sys_setns_returned)
...
PPP_CB_BOILERPLATE(on_sys_waitpid)
...
PPP_CB_BOILERPLATE(on_sys_sgetmask)
...
PPP_CB_BOILERPLATE(on_sys_sendmmsg)
#endif
