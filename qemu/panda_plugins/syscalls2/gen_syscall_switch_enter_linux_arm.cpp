...
#include "gen_syscall_ppp_register_enter_linux_arm.cpp"  // osarch
}

#include "gen_syscall_ppp_boilerplate_enter_linux_arm.cpp" // osarch
...
case 100000: {
PPP_RUN_CB(on_sys_linux_arm_enter, env,pc) ; 
}; break;
