...
void syscall_return_switch_windowsxp_x86 ( CPUState *env, target_ulong pc, target_ulong ordinal);
...
void syscall_enter_switch_windowsxp_x86 ( CPUState *env, target_ulong pc ) ;
