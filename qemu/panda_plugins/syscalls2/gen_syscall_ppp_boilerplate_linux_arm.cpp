...
PPP_CB_BOILERPLATE(on_sys_enter_linux_arm_return)
...
PPP_CB_BOILERPLATE(on_sys_return_linux_arm_return)
...
PPP_CB_BOILERPLATE(on_sys_enter_linux_arm_enter)
...
PPP_CB_BOILERPLATE(on_sys_return_linux_arm_enter)
