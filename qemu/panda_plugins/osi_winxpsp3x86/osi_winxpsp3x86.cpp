 ...
 *  Evan Downing           edowning3@gatech.edu
 * 
...
/*
  NOTE - KTHREAD_KPROC should be _KTHREAD.Process, but this does not exist in
         Windows XP SP3 like it does in Windows 7.
         _ETHREAD.ThreadsProcess should work just fine
*/
#define KTHREAD_KPROC_OFF  0x220 // _ETHREAD.ThreadsProcess
